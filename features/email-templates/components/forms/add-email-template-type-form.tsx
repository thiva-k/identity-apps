                ...
                <GridRow columns={2}>
                    <GridColumn mobile={16} tablet={16} computer={8}>
                        <Field
                            ...
                            name="templatetype"
                            label={t(
                                "console:manage.features.emailTemplateTypes.forms.addTemplateType.fields.type.label"
                            )}
                            placeholder={t(
                                "console:manage.features.emailTemplateTypes.forms.addTemplateType.fields.type" +
                                    ".placeholder"
                            )}
                            required={true}
