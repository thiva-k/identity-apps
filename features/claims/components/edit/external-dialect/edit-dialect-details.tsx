...
export const EditDialectDetails: FunctionComponent<EditDialectDetailsPropsInterface> = (
    ...
    const { dialect, attributeType, onUpdate, ["data-testid"]: testId } = props;
                    ...
                    >
                        <Field
                            ...
                            requiredErrorMessage={t(
                                "console:manage.features.claims.dialects." + "forms.dialectURI.requiredErrorMessage"
                            )}
                        ...
                        />
                        {config.ui?.isDefaultDialectEditingEnabled === false &&
                        ClaimManagementConstants.DEFAULT_DIALECTS.includes(dialect?.id) ? null : (
                            <>
                                <Divider hidden />
                                <PrimaryButton
                                    type="submit"
