...
import { GitHubAuthenticationProviderCreateWizardContent } from "./github-authentication-provider-create-wizard-content";
 ...
 */
interface GitHubAuthenticationProviderCreateWizardPropsInterface
 ...
 */
export const GitHubAuthenticationProviderCreateWizard: FunctionComponent<GitHubAuthenticationProviderCreateWizardPropsInterface> = (
    ...
    const onSubmitWizard = (values: GitHubAuthenticationProviderCreateWizardFormValuesInterface): void => {
        ...
        identityProvider.image = "assets/images/logos/github.svg";
