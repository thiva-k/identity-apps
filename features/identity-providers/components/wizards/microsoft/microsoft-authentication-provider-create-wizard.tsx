 ...
 */
export interface MicrosoftAuthenticationProviderCreateWizardFormValuesInterface {
    /**
     * Microsoft Authenticator Client Secret.
     */
    clientSecret: string;
    /**
     * Callback URL.
    ...
    callbackUrl: string;
    /**
     * Microsoft Authenticator Client ID.
     */
    clientId: string;
    /**
     * Microsoft Authenticator name.
     */
    name: string;
}

/**
 * Proptypes for the Microsoft Authentication Wizard Form error messages.
 */
export interface MicrosoftAuthenticationProviderCreateWizardFormErrorValidationsInterface {
    /**
 ...
 */
MicrosoftAuthenticationProviderCreateWizard.defaultProps = {
    currentStep: 1,
