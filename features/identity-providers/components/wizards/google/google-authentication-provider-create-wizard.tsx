...
import { AppState, ConfigReducerStateInterface, EventPublisher, ModalWithSidePanel } from "../../../../core";
 ...
 */
interface MinimalAuthenticationProviderCreateWizardPropsInterface
 ...
 * @returns GoogleAuthenticationProviderCreateWizard component.
 */
export const GoogleAuthenticationProviderCreateWizard: FunctionComponent<MinimalAuthenticationProviderCreateWizardPropsInterface> = (
    ...
    //TODO: Remove unnecessary states setters.
    const [, setDefaultAuthenticatorMetadata] = useState<FederatedAuthenticatorMetaInterface>(undefined);
    const [, setDefaultOutboundProvisioningConnectorMetadata] = useState<OutboundProvisioningConnectorMetaInterface>(
        undefined
    );
    ...
    const onSubmitWizard = (values: GoogleAuthenticationProviderCreateWizardFormValuesInterface): void => {
        ...
        identityProvider.federatedAuthenticators.authenticators[0].isEnabled = !(
            isEmpty(values?.clientId.toString()) || isEmpty(values?.clientSecret.toString())
        );
