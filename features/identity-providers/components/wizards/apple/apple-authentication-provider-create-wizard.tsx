...
import { AppleAuthenticationProviderCreateWizardContent } from "./apple-authentication-provider-create-wizard-content";
 ...
 */
interface AppleAuthenticationProviderCreateWizardPropsInterface
 ...
 */
export const AppleAuthenticationProviderCreateWizard: FunctionComponent<AppleAuthenticationProviderCreateWizardPropsInterface> = (
            ...
            <ModalWithSidePanel.SidePanel>
                <ModalWithSidePanel.Header className="wizard-header help-panel-header muted">
                    <div className="help-panel-header-text">
                        {t("console:develop.features.authenticationProvider.templates" + ".apple.wizardHelp.heading")}
                    </div>
