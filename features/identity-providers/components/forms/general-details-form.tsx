                ...
                >
                    ...
                    {isTrustedTokenIssuer && (
                        <Field.Input
                            ...
                            name="idpIssuerName"
                            label={t(
                                "console:develop.features.authenticationProvider.forms." + "generalDetails.issuer.label"
                            )}
                            hint={t(
                                "console:develop.features.authenticationProvider.forms." + "generalDetails.issuer.hint"
                            )}
                            required
                    ...
                    {isTrustedTokenIssuer && (
                        <Field.Input
                            ...
                            name="alias"
                            label={t(
                                "console:develop.features.authenticationProvider.forms." + "generalDetails.alias.label"
                            )}
                            required={false}
                            message={t(
                                "console:develop.features.authenticationProvider." +
                            ...
                            hint={t(
                                "console:develop.features.authenticationProvider.forms." + "generalDetails.alias.hint",
