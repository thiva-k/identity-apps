...
import { RoleAPIResourcesListItem } from "@wso2is/feature-roles.common/components/edit-role/edit-role-common/role-api-resources-list-item";
                    ...
                    {isSubscribedAPIResourcesListLoading ? (
                        ...
                        <Autocomplete
                            ...
                            options={apiResourcesListOptions
                                ...
                                .sort((a: DropdownProps, b: DropdownProps) => -b?.type?.localeCompare(a?.type))}
