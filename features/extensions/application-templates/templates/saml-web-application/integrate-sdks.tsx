...
import { SAMLIntegrateSDKConfigInterface, SupportedTraditionalSAMLAppTechnologyTypes } from "./models";
import {
...
export const IntegrateSDKs: FunctionComponent<IntegrateSDKsPropsInterface> = (
    ...
    const { inboundProtocolConfig, technology, ["data-testid"]: testId } = props;
        ...
        return (
            <>
                <Form>
                    ...
                    <Hint>
                        The configuration <code className="inline-code">skipURIs</code> depends on your{" "}
                        <strong>App context path</strong>.
                    </Hint>
                </Form>
        ...
        if (technology === SupportedTraditionalSAMLAppTechnologyTypes.JAVA_EE) {
            return (
                <>
                    ...
                    <Text>
                        Create a file named <code className="inline-code">sample-app.properties</code> inside the{" "}
                    ...
                    <Text>
                        ...
                        keystore file and copy it to the{" "}
                        <code className="inline-code">&#60;APP_HOME&#62;/src/main/resources</code> directory.
                        <br />
                        <br />
                        Make sure to update <code className="inline-code">KeyStorePassword</code> and{" "}
                        <code className="inline-code">PrivateKeyAlias</code> with relevant values.
                    </Text>

                    <Text>
                        Finally, copy and paste the following configuration to the
                        <code className="inline-code">&#60;APP_HOME&#62;/WEB-INF/web.xml</code> file and change the{" "}
                        <strong>certificate-file</strong> parameter with the name of your keystore file.
                    </Text>
    ...
    const generateLogoutStep = (technology: SupportedTraditionalSAMLAppTechnologyTypes): ReactNode => {
        if (technology === SupportedTraditionalSAMLAppTechnologyTypes.JAVA_EE) {
            return (
                <>
                    <Text>Add the following snippet to enable logout from a secured page.</Text>
            ...
            return (
                <>
                    <p>
                        ...
                        some of the steps if you&apos;re working with a different application container or technology.
                    </p>
