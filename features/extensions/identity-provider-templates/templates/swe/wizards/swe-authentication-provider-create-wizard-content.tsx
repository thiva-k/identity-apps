...
import { useIdentityProviderList } from "../../../../../identity-providers/api";
import { handleGetIDPListCallError } from "../../../../../identity-providers/components/utils";
 ...
 */
export const SIWEAuthenticationProviderCreateWizardContent: FunctionComponent<SIWEAuthenticationProviderCreateWizardContentPropsInterface> = (
    ...
    const idpNameValidation = (value: any): string => {
        ...
        return t(
            "console:develop.features." + "authenticationProvider.forms.generalDetails.name." + "validations.duplicate"
        );
    };
     ...
     */
    const validateForm = (
        values: SIWEAuthenticationProviderCreateWizardFormValuesInterface
    ): SIWEAuthenticationProviderCreateWizardFormErrorValidationsInterface => {
    ...
    return (
        <Wizard
            ...
            onSubmit={(values: SIWEAuthenticationProviderCreateWizardFormValuesInterface) => onSubmit(values)}
        ...
        >
            <WizardPage validate={validateForm}>
                ...
                <Field.Input
                    ...
                    name="clientId"
                    label={t(
                        "extensions:develop.identityProviders.siwe.forms" + ".authenticatorSettings.clientId.label"
                    )}
                    placeholder={t(
