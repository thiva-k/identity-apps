 ...
 */
interface SIWEAuthenticationProviderCreateWizardPropsInterface
 ...
 */
export const SIWEAuthenticationProviderCreateWizard: FunctionComponent<SIWEAuthenticationProviderCreateWizardPropsInterface> = (
    ...
    const onSubmitWizard = (values: SIWEAuthenticationProviderCreateWizardFormValuesInterface): void => {
        ...
        identityProvider.federatedAuthenticators.authenticators[0].properties = identityProvider?.federatedAuthenticators?.authenticators[0]?.properties?.filter(
