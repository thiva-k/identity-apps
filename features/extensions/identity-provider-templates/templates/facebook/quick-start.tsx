 ...
 *
 * @returns Facebook IDP template quick start component.
 */
    ...
    const steps: VerticalStepperStepInterface[] = [
        {
            ...
            stepTitle: t("extensions:develop.identityProviders.facebook.quickStart.steps.selectApplication.heading")
        },
        {
            stepContent: (
                <>
        ...
        <>
            ...
            {showApplicationModal && (
                <ApplicationSelectionModal
                    ...
                    heading={t("extensions:develop.identityProviders.facebook.quickStart.addLoginModal.heading")}
                    subHeading={t("extensions:develop.identityProviders.facebook.quickStart.addLoginModal.subHeading")}
                />
            )}
        </>
    );
