        ...
        <>
            {isManagedByChoreo && (
                <Alert severity="warning">
                    <Trans i18nKey={"extensions:develop.apiResource.tabs.choreoApiEditWarning"}>
                        Updating this API resource will create unforeseen errors as this is an API resource managed by
                        Choreo. <b>Proceed with caution.</b>
                    </Trans>
                </Alert>
            )}
            ...
            {deletingAPIResourcePermission && (
                <ConfirmationModal
                    ...
                    type="negative"
                    assertionHint={t(
                        "extensions:develop.apiResource.confirmations." + "deleteAPIResourcePermission.assertionHint"
                    )}
                ...
                >
                    <ConfirmationModal.Header data-testid={`${componentId}-delete-confirmation-modal-header`}>
                        {t("extensions:develop.apiResource.confirmations.deleteAPIResourcePermission." + "header")}
                    ...
                    >
                        {t("extensions:develop.apiResource.confirmations.deleteAPIResourcePermission." + "message")}
                    </ConfirmationModal.Message>
                    <ConfirmationModal.Content data-testid={`${componentId}-delete-confirmation-modal-content`}>
                        {t("extensions:develop.apiResource.confirmations.deleteAPIResourcePermission." + "content")}
