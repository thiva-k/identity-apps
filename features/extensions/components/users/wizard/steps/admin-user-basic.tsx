...
export const AddAdminUserBasic: React.FunctionComponent<AddAdminUserBasicProps> = (
    ...
    const USERNAME_REGEX_VIOLATION_ERROR_MESSAGE: string = t(
        "console:manage.features.users.guestUsers.fields." + "username.validations.regExViolation"
    );
     ...
     * @param string - query
     */
    const handleSearchFieldChange: DebouncedFunc<(e: FormEvent<HTMLInputElement>, query: string) => void> = useCallback(
        debounce((e: FormEvent<HTMLInputElement>, query: string) => {
            if (query === "") {
                setSearchQuery("");
            } else {
    ...
    const inviteInternalUserForm = () => (
        ...
        >
            ...
            <TransferComponent
                ...
                selectionComponent
                searchPlaceholder={t("extensions:manage.users.wizard.addAdmin.internal.searchPlaceholder")}
                    ...
                    <Grid.Row columns={1}>
                        <Grid.Column mobile={16} tablet={16} computer={12}>
                            <Field
                                ...
                                label={t("console:manage.features.user.forms.addUserForm.inputs.email.label")}
                                name="email"
                                placeholder={t(
                                    ...
                                    if (
                                        ...
                                        (!FormValidation.email(value) ||
                                            !SharedUserStoreUtils.validateInputAgainstRegEx(
                                                value,
                                                window["AppUtils"].getConfig().extensions.collaboratorUsernameRegex
                                            ))
                                    ) {
                    ...
                    <Grid.Row columns={1}>
                        <Grid.Column mobile={16} tablet={16} computer={12}>
                            ...
                            <Hint>
                                ...
                                <DocumentationLink link={getLink("manage.users.newCollaboratorUser.learnMore")}>
    ...
    return administratorType === AdminAccountTypes.INTERNAL ? inviteInternalUserForm() : inviteExternalUserForm();
};
