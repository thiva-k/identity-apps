    ...
    useEffect(() => {
        ...
        if (selectedAPIResource) {
            setScopesDropdownOptions(
                selectedAPIResource?.permissions.map((scope: APIResourcePermissionInterface) => {
                    return {
                        content: (
                                ...
                                <Grid.Column mobile={16} tablet={16} computer={12}>
                                    <Grid>
                                        <Grid.Row columns={2}>
                                            ...
                                            >
                                                <label>
                                                    <Text size={13} className="mb-1" muted={!selectedAPIResource}>
                                                        {t(
                                                            "extensions:develop.applications.edit.sections." +
                                                                "apiAuthorization.sections.apiSubscriptions.wizards." +
                            ...
                            <Grid.Row columns={1} className="pt-2">
                                <Grid.Column mobile={16} tablet={16} computer={12}>
                                    <Popup
                                        ...
                                        disabled={!selectedAPIResource || !selectedAPIResourceRequiresAuthorization}
                                        inverted
                                        trigger={
                                            <label>
                                                <Text
                                        ...
                                        <Message
                                            ...
                                            content={
                                                <>
                                                    ...
                                                    <DocumentationLink
                                                        link={getLink(
                                                            policyDetails.get(selectedPolicy).documentationLink()
                                                        )}
                                                    >
