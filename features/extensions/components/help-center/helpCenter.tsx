...
export default (): ReactElement => {
    ...
    return (helpCenterURL || docSiteURL) && (helpCenterURL !== "" || docSiteURL !== "") ? (
            ...
            <Dropdown
                ...
                trigger={
                    <GenericIcon
                        ...
                        hoverable
                        hoverType="circular"
                        icon={<Icon className="help-center-button-icon" size="large" name="question circle outline" />}
            ...
            >
                <Dropdown.Menu>
                    {docSiteURL && docSiteURL !== "" && (
                        ...
                        >
                            <GenericIcon transparent icon={<DocIcon />} size="auto" floated="left" spaced="right" />
                    ...
                    {helpCenterURL && helpCenterURL !== "" && (
                        ...
                        >
                            <GenericIcon transparent icon={<HelpIcon />} size="auto" floated="left" spaced="right" />
