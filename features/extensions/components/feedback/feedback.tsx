...
export default (): ReactElement => {
        ...
        if (
            ...
            return (
                <Grid columns={2}>
                        ...
                        <Grid.Column>
                            <Field
                                ...
                                requiredErrorMessage={
                                    "Email cannot be empty if you want us " + "to contact you regarding this feedback"
                                }
                    ...
                    <Hint>
                        Your contact details will not be used for any purpose other than this. Please see our{" "}
                ...
                <>
                    ...
                    {isContactAllowed && (
                        <Field
                            ...
                            requiredErrorMessage={
                                "Email cannot be empty if you are okay with us " +
    ...
    const handleDisplayMessage = () => {
        if (
            feedbackOption &&
            (isContactAllowed ||
                feedbackOption === "helpRequest" ||
                feedbackOption === "contactUs" ||
                feedbackOption === "other")
        ) {
            return (
                <>
                    <Heading size="medium"> Thank you for submitting your feedback. </Heading>
                    <Heading subHeading compact size="small">
                        {" "}
                        We need some time to review your request.
                    </Heading>
                    <Heading subHeading size="small">
                        {" "}
                        When we are done, we will be in touch.
                    </Heading>
                </>
            );
        } else if (
    ...
    const STEPS: any[] = [
        {
            content: (
                <>
                    <Forms
                        onSubmit={(formValue: Map<string, FormValue>) => submitFeedback(formValue)}
                        submitState={submit}
                            ...
                            <Grid.Row>
                                <Grid.Column>
                                    <input
                                        ...
                                        id="suggestion"
                                        onChange={(values: any) => {
                                            setFeedbackOption(values.currentTarget.value.toString());
                                        }}
                                    />
                        ...
                        <Grid.Row>
                            <Grid.Column mobile={16} tablet={16} computer={16} textAlign="center">
                                <div style={{ padding: "1rem" }}>
                                    ...
                                    <Divider hidden />
                                    <PrimaryButton size="medium" onClick={(): void => closeWizard()}>
                                        Close
                                    </PrimaryButton>
                                </div>
                            </Grid.Column>
    ...
    return (
        <>
            ...
            {showFeedback && (
                ...
                >
                    {currentWizardStep == 0 && (
                        <Modal.Header className="wizard-header">Let us Discuss Your Feedback</Modal.Header>
                    )}
