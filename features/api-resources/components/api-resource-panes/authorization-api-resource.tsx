...
import { ContentLoader, DocumentationLink, EmphasizedSegment, useDocumentation } from "@wso2is/react-components";
import React, { FunctionComponent, ReactElement } from "react";
import { useTranslation } from "react-i18next";
import { APIResourcePanesCommonPropsInterface } from "../../models";
...
export const AuthorizationAPIResource: FunctionComponent<AuthorizationAPIResourceInterface> = (
    ...
    const { apiResourceData, isAPIResourceDataLoading, ["data-componentid"]: componentId } = props;
                ...
                <EmphasizedSegment padded="very">
                    ...
                    >
                        <Field.Checkbox
                            ...
                            name="authorization"
                            label={t(
                                "extensions:develop.apiResource.tabs.authorization.form" + ".fields.authorize.label"
                            )}
                            hint={
                                <>
                                    {t(
                                        "extensions:develop.apiResource.tabs.authorization.form" +
                                            ".fields.authorize.hint"
                                    )}
                                    <DocumentationLink
                                        link={getLink(
                                            "develop.apiResources.addAPIResource." + "requiredAuthorization.learnMore"
                                        )}
                                    >
