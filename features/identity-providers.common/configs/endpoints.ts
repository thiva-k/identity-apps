...
import { getServerConfigurationsResourceEndpoints } from "../../server-configurations.common/configs/endpoints";
import { IDPResourceEndpointsInterface } from "../models/endpoints";
