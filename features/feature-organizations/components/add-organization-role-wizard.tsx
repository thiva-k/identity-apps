...
export const AddOrganizationRoleWizard: FunctionComponent<AddOrganizationRoleProps> = (
    ...
    const { closeWizard, initStep, updateList, isAddGroup, onCreateRoleRequested, ["data-testid"]: testId } = props;
    ...
    useEffect(() => {
        getGroupList(null).then((response: AxiosResponse) => {
    ...
    const WIZARD_STEPS: WizardStepInterface[] = [
        {
            content: (
                <OrganizationRoleBasics
                    ...
                    onSubmit={(values: WizardBasicDetailsInterface) =>
        ...
        },
        {
            content: (
                <OrganizationPermissionList
                    ...
                    onSubmit={(values: WizardPermissionInterface[]) =>
        ...
        },
        {
            content: (
                <AssignGroupsUsers
                    ...
                    handleAddedGroupInitialListChange={(groups: GroupsInterface[]) =>
