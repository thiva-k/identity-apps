...
export class AccessControlUtils {
    public static getPermissions = (
        ...
        return {
            [AccessControlConstants.API_RESOURCES]: hasRequiredScopes(
                featureConfig?.apiResources,
                featureConfig?.apiResources?.scopes?.feature,
                allowedScopes
            ),
            [AccessControlConstants.API_RESOURCES_READ]: hasRequiredScopes(
                featureConfig?.apiResources,
                featureConfig?.apiResources?.scopes?.read,
                allowedScopes
            ),
            [AccessControlConstants.API_RESOURCES_WRITE]: hasRequiredScopes(
                featureConfig?.apiResources,
                featureConfig?.apiResources?.scopes?.create,
                allowedScopes
            ),
            [AccessControlConstants.API_RESOURCES_EDIT]: hasRequiredScopes(
                featureConfig?.apiResources,
                featureConfig?.apiResources?.scopes?.update,
                allowedScopes
            ),
            [AccessControlConstants.API_RESOURCES_DELETE]: hasRequiredScopes(
                featureConfig?.apiResources,
                featureConfig?.apiResources?.scopes?.delete,
                allowedScopes
            ),

            [AccessControlConstants.APPLICATION]: hasRequiredScopes(
                featureConfig?.applications,
                featureConfig?.applications?.scopes?.feature,
                allowedScopes
            ),
            [AccessControlConstants.APPLICATION_READ]: hasRequiredScopes(
                featureConfig?.applications,
                featureConfig?.applications?.scopes?.read,
                allowedScopes
            ),
            [AccessControlConstants.APPLICATION_WRITE]: hasRequiredScopes(
                featureConfig?.applications,
                featureConfig?.applications?.scopes?.create,
                allowedScopes
            ),
            [AccessControlConstants.APPLICATION_EDIT]: hasRequiredScopes(
                featureConfig?.applications,
                featureConfig?.applications?.scopes?.update,
                allowedScopes
            ),
            [AccessControlConstants.APPLICATION_DELETE]: hasRequiredScopes(
                featureConfig?.applications,
                featureConfig?.applications?.scopes?.delete,
                allowedScopes
            ),

            [AccessControlConstants.ATTRIBUTE]: hasRequiredScopes(
                featureConfig?.attributeDialects,
                featureConfig?.attributeDialects?.scopes?.feature,
                allowedScopes
            ),
            [AccessControlConstants.ATTRIBUTE_READ]: hasRequiredScopes(
                featureConfig?.attributeDialects,
                featureConfig?.attributeDialects?.scopes?.read,
                allowedScopes
            ),
            [AccessControlConstants.ATTRIBUTE_WRITE]: hasRequiredScopes(
                featureConfig?.attributeDialects,
                featureConfig?.attributeDialects?.scopes?.create,
                allowedScopes
            ),
            [AccessControlConstants.ATTRIBUTE_EDIT]: hasRequiredScopes(
                featureConfig?.attributeDialects,
                featureConfig?.attributeDialects?.scopes?.update,
                allowedScopes
            ),
            [AccessControlConstants.ATTRIBUTE_DELETE]: hasRequiredScopes(
                featureConfig?.attributeDialects,
            ...
            [AccessControlConstants.CERTIFICATES]: hasRequiredScopes(
                featureConfig?.certificates,
                featureConfig?.certificates?.scopes?.feature,
                allowedScopes
            ),
            [AccessControlConstants.CERTIFICATES_READ]: hasRequiredScopes(
                featureConfig?.certificates,
                featureConfig?.certificates?.scopes?.read,
                allowedScopes
            ),
            [AccessControlConstants.CERTIFICATES_WRITE]: hasRequiredScopes(
                featureConfig?.certificates,
                featureConfig?.certificates?.scopes?.create,
                allowedScopes
            ),
            [AccessControlConstants.CERTIFICATES_EDIT]: hasRequiredScopes(
                featureConfig?.certificates,
                featureConfig?.certificates?.scopes?.update,
                allowedScopes
            ),
            [AccessControlConstants.CERTIFICATES_DELETE]: hasRequiredScopes(
                featureConfig?.certificates,
            ...
            [AccessControlConstants.GROUP]: hasRequiredScopes(
                featureConfig?.groups,
                featureConfig?.groups?.scopes?.feature,
                allowedScopes
            ),
            [AccessControlConstants.GROUP_READ]: hasRequiredScopes(
                featureConfig?.groups,
                featureConfig?.groups?.scopes?.read,
                allowedScopes
            ),
            [AccessControlConstants.GROUP_WRITE]: hasRequiredScopes(
                featureConfig?.groups,
                featureConfig?.groups?.scopes?.create,
                allowedScopes
            ),
            [AccessControlConstants.GROUP_EDIT]: hasRequiredScopes(
                featureConfig?.groups,
                featureConfig?.groups?.scopes?.update,
                allowedScopes
            ),
            [AccessControlConstants.GROUP_DELETE]: hasRequiredScopes(
                featureConfig?.groups,
                featureConfig?.groups?.scopes?.delete,
                allowedScopes
            ),

            [AccessControlConstants.IDP]: hasRequiredScopes(
                featureConfig?.identityProviders,
                featureConfig?.identityProviders?.scopes?.feature,
                allowedScopes
            ),
            [AccessControlConstants.IDP_READ]: hasRequiredScopes(
                featureConfig?.identityProviders,
                featureConfig?.identityProviders?.scopes?.read,
                allowedScopes
            ),
            [AccessControlConstants.IDP_WRITE]: hasRequiredScopes(
                featureConfig?.identityProviders,
                featureConfig?.identityProviders?.scopes?.create,
                allowedScopes
            ),
            [AccessControlConstants.IDP_EDIT]: hasRequiredScopes(
                featureConfig?.identityProviders,
                featureConfig?.identityProviders?.scopes?.update,
                allowedScopes
            ),
            [AccessControlConstants.PROVIDER_EDIT]: hasRequiredScopes(
                featureConfig?.smsProviders,
                featureConfig?.smsProviders?.scopes?.create,
                allowedScopes
            ),
            [AccessControlConstants.IDP_DELETE]: hasRequiredScopes(
                featureConfig?.identityProviders,
                featureConfig?.identityProviders?.scopes?.delete,
                allowedScopes
            ),

            [AccessControlConstants.IDVP_READ]: hasRequiredScopes(
                featureConfig?.identityVerificationProviders,
                featureConfig?.identityVerificationProviders?.scopes?.read,
                allowedScopes
            ),
            [AccessControlConstants.IDVP_WRITE]: hasRequiredScopes(
                featureConfig?.identityVerificationProviders,
                featureConfig?.identityVerificationProviders?.scopes?.create,
                allowedScopes
            ),
            [AccessControlConstants.IDVP_EDIT]: hasRequiredScopes(
                featureConfig?.identityVerificationProviders,
                featureConfig?.identityVerificationProviders?.scopes?.update,
                allowedScopes
            ),
            [AccessControlConstants.IDVP_DELETE]: hasRequiredScopes(
                featureConfig?.identityVerificationProviders,
                featureConfig?.identityVerificationProviders?.scopes?.delete,
                allowedScopes
            ),

            [AccessControlConstants.ROLE]: hasRequiredScopes(
                featureConfig?.userRoles,
                featureConfig?.userRoles?.scopes?.feature,
                allowedScopes
            ),
            [AccessControlConstants.ROLE_READ]: hasRequiredScopes(
                featureConfig?.userRoles,
                featureConfig?.userRoles?.scopes?.read,
                allowedScopes
            ),
            [AccessControlConstants.ROLE_WRITE]: hasRequiredScopes(
                featureConfig?.userRoles,
                featureConfig?.userRoles?.scopes?.create,
                allowedScopes
            ),
            [AccessControlConstants.ROLE_EDIT]: hasRequiredScopes(
                featureConfig?.userRoles,
                featureConfig?.userRoles?.scopes?.update,
                allowedScopes
            ),
            [AccessControlConstants.ROLE_DELETE]: hasRequiredScopes(
                featureConfig?.userRoles,
                featureConfig?.userRoles?.scopes?.delete,
                allowedScopes
            ),

            [AccessControlConstants.SCOPE]: hasRequiredScopes(
                featureConfig?.oidcScopes,
                featureConfig?.oidcScopes?.scopes?.feature,
                allowedScopes
            ),
            [AccessControlConstants.SCOPE_READ]: hasRequiredScopes(
                featureConfig?.oidcScopes,
                featureConfig?.oidcScopes?.scopes?.read,
                allowedScopes
            ),
            [AccessControlConstants.SCOPE_WRITE]: hasRequiredScopes(
                featureConfig?.oidcScopes,
                featureConfig?.oidcScopes?.scopes?.create,
                allowedScopes
            ),
            [AccessControlConstants.SCOPE_EDIT]: hasRequiredScopes(
                featureConfig?.oidcScopes,
                featureConfig?.oidcScopes?.scopes?.update,
                allowedScopes
            ),
            [AccessControlConstants.SCOPE_DELETE]: hasRequiredScopes(
                featureConfig?.oidcScopes,
                featureConfig?.oidcScopes?.scopes?.delete,
                allowedScopes
            ),
            ...
            [AccessControlConstants.USER]: hasRequiredScopes(
                featureConfig?.users,
                featureConfig?.users?.scopes?.feature,
                allowedScopes
            ),
            [AccessControlConstants.USER_READ]: hasRequiredScopes(
                featureConfig?.users,
                featureConfig?.users?.scopes?.read,
                allowedScopes
            ),
            [AccessControlConstants.USER_WRITE]: hasRequiredScopes(
                featureConfig?.users,
                featureConfig?.users?.scopes?.create,
                allowedScopes
            ),
            [AccessControlConstants.USER_EDIT]: hasRequiredScopes(
                featureConfig?.users,
                featureConfig?.users?.scopes?.update,
                allowedScopes
            ),
            [AccessControlConstants.USER_DELETE]: hasRequiredScopes(
                featureConfig?.users,
                featureConfig?.users?.scopes?.delete,
                allowedScopes
            ),

            [AccessControlConstants.USER_STORE]: hasRequiredScopes(
                featureConfig?.userStores,
                featureConfig?.userStores?.scopes?.feature,
                allowedScopes
            ),
            [AccessControlConstants.USER_STORE_READ]: hasRequiredScopes(
                featureConfig?.userStores,
                featureConfig?.userStores?.scopes?.read,
                allowedScopes
            ),
            [AccessControlConstants.USER_STORE_WRITE]: hasRequiredScopes(
                featureConfig?.userStores,
                featureConfig?.userStores?.scopes?.create,
                allowedScopes
            ),
            [AccessControlConstants.USER_STORE_EDIT]: hasRequiredScopes(
                featureConfig?.userStores,
                featureConfig?.userStores?.scopes?.update,
                allowedScopes
            ),
            [AccessControlConstants.USER_STORE_DELETE]: hasRequiredScopes(
                featureConfig?.userStores,
