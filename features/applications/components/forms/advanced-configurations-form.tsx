...
import SAMLWebApplicationTemplate from "../../data/application-templates/templates/saml-web-application/saml-web-application.json";
...
export const AdvancedConfigurationsForm: FunctionComponent<AdvancedConfigurationsFormPropsInterface> = (
    ...
    const { config, onSubmit, readOnly, template, isSubmitting, onAlertFired, ["data-testid"]: testId } = props;
    ...
    return (
        ...
        >
            ...
            <Field.CheckboxLegacy
                ...
                label={t(
                    "console:develop.features.applications.forms.advancedConfig.fields.skipConsentLogin" + ".label"
                )}
                required={false}
            ...
            {SAMLWebApplicationTemplate?.id !== template?.id && (
                <Field.CheckboxLegacy
                    ...
                    label={t(
                        "console:develop.features.applications.forms.advancedConfig.fields" + ".skipConsentLogout.label"
                    )}
                    required={false}
                    ...
                    hint={t(
                        "console:develop.features.applications.forms.advancedConfig.fields.skipConsentLogout" + ".hint"
                    )}
                />
            )}
            <Field.CheckboxLegacy
            ...
            <Field.CheckboxLegacy
                ...
                label={t(
                    "console:develop.features.applications.forms.advancedConfig.fields." + "enableAuthorization.label"
                )}
                required={false}
                ...
                <>
                    <Grid>
                        <Grid.Row columns={2}>
                            ...
                            <Grid.Column mobile={16} tablet={16} computer={16}>
                                <Heading as="h4">{"Application native authentication"}</Heading>

                                {isClientAttestationUIDisabled && isUserClickedClientAttestationWhenDisabled && (
                                ...
                                <Field.CheckboxLegacy
                                    ...
                                    required={false}
                                    readOnly={readOnly}
                                    value={isEnableAPIBasedAuthentication ? ["enableAPIBasedAuthentication"] : []}
                                ...
                                <Grid.Row columns={1} onClick={handleWhenClientAttestationClickedWhenDisabled}>
                                    <Grid.Column>
                                        <Field.Textarea
                                            ...
                                            data-componentid={`${testId}-client-attestation-android-account-credentials`}
                                            disabled={isClientAttestationMethodsUiDisabled}
                                            readOnly={readOnly}
                                        />
                                    </Grid.Column>
