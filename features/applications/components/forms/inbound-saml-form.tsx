        ...
        return {
            ...
            inbound: {
                manualConfiguration: {
                    ...
                    enableAssertionQueryProfile: values
                        .get("assertionQueryProfile")
                        ?.includes("enableAssertionQueryProfile"),
                    idpEntityIdAlias: values.get("idpEntityIdAlias"),
                    issuer: values.get("issuer") || initialValues?.issuer,
                    requestValidation: {
                        enableSignatureValidation:
                            isCertAvailableForEncrypt &&
                            values.get("requestSignatureValidation").includes("enableSignatureValidation"),
                    ...
                    singleSignOnProfile: {
                        assertion: {
                            ...
                            encryption: {
                                ...
                                keyEncryptionAlgorithm: isCertAvailableForEncrypt
                                    ? values.get("keyEncryptionAlgorithm")
                        ...
                        enableSignatureValidationForArtifactBinding:
                            ...
                            values
                                .get("signatureValidationForArtifactBinding")
    ...
    useEffect(() => {
        if (initialValues) {
            ...
            setIsArtifactBindingEnabled(
                initialValues?.singleSignOnProfile?.bindings?.includes(SAML2BindingTypes.ARTIFACT)
            );
        }
    }, [initialValues]);
            ...
            <Grid>
                <Grid.Row columns={1}>
                    <Grid.Column mobile={16} tablet={16} computer={16}>
                        ...
                        <Hint>
                            <Trans
                                i18nKey={
                                    "console:develop.features.applications.forms.inboundSAML.fields." + "issuer.hint"
                                }
                            >
                                This specifies the unique identifier of the application. This is also the
                                <Code withBackground>saml2:Issuer</Code> value specified in the SAML authentication
                ...
                <Grid.Row columns={1}>
                    <Grid.Column mobile={16} tablet={16} computer={16}>
                        <URLInput
                            ...
                            hint={t(
                                "console:develop.features.applications.forms.inboundSAML.fields" + ".assertionURLs.hint"
                            )}
                            readOnly={readOnly}
                ...
                <Grid.Row columns={1}>
                    <Grid.Column mobile={16} tablet={16} computer={16}>
                        <Field
                            ...
                            default={!isEmpty(assertionConsumerUrls) && assertionConsumerUrls.split(",").slice(-1)[0]}
                    ...
                    <Grid.Column mobile={16} tablet={16} computer={16}>
                        ...
                        <Hint>
                            ...
                            >
                                ...
                                <Code withBackground>saml2:Issuer</Code> of the SAML response that is generated by
                                productName.
                            </Trans>
                        </Hint>
                    </Grid.Column>
                ...
                <Grid.Row columns={2}>
                    ...
                    <Grid.Column mobile={16} tablet={16} computer={16}>
                        <Heading as="h5">
                            {t(
                                "console:develop.features.applications.forms.inboundSAML.sections" +
                    ...
                    <Grid.Column mobile={16} tablet={16} computer={16}>
                        ...
                        <Grid.Column mobile={16} tablet={16} computer={16}>
                            <Field
                                ...
                                listen={(values: Map<string, FormValue>) => {
                                    setSignSAMLResponsesEnabled(values.get("responseSigning").includes("enabled"));
                                }}
                                children={[
                                    {
                                        label: t(
                ...
                <Grid.Row columns={2}>
                    ...
                    <Grid.Column mobile={16} tablet={16} computer={16}>
                        ...
                        <Field
                            ...
                            value={union(initialValues?.singleSignOnProfile?.bindings, ["HTTP_POST", "HTTP_REDIRECT"])}
                            readOnly={readOnly}
                            listen={(values: Map<string, FormValue>) => {
                                setIsArtifactBindingEnabled(values.get("bindings").includes("ARTIFACT"));
                        ...
                        <Grid.Column mobile={16} tablet={16} computer={16}>
                            <Field
                                ...
                                value={
                                    ...
                                    initialValues?.singleSignOnProfile.enableSignatureValidationForArtifactBinding
                                        ? ["enableSignatureValidationForArtifactBinding"]
                                        : []
                                }
                                children={[
                ...
                <Grid.Row columns={2}>
                    ...
                    <Grid.Column mobile={16} tablet={16} computer={16}>
                        <Heading as="h5">
                            {t(
                                "console:develop.features.applications.forms.inboundSAML.sections.assertion" +
                                    ".heading"
                            )}
                        </Heading>
                        <Divider hidden />
                    ...
                    <Grid.Column mobile={16} tablet={16} computer={16}>
                        <URLInput
                            ...
                            setURLState={(url: string) => {
                                ...
                                if (initialValues?.singleSignOnProfile?.assertion?.audiences?.toString() !== url) {
                                    setIsFormStale(true);
                                }
                            }}
                            labelName={t(
                    ...
                    <Grid.Column mobile={16} tablet={16} computer={16}>
                        <URLInput
                            ...
                            setURLState={(url: string) => {
                                ...
                                if (initialValues?.singleSignOnProfile?.assertion?.recipients?.toString() !== url) {
                                    setIsFormStale(true);
                                }
                            }}
                            labelName={t(
                ...
                <Grid.Row columns={1}>
                    <Grid.Column mobile={16} tablet={16} computer={16}>
                        <Field
                            ...
                            value={initialValues?.singleSignOnProfile.assertion.encryption.assertionEncryptionAlgorithm}
                ...
                <Grid.Row columns={1}>
                    <Grid.Column mobile={16} tablet={16} computer={16}>
                        <Field
                            ...
                            value={initialValues?.singleSignOnProfile.assertion.encryption.keyEncryptionAlgorithm}
                ...
                <Grid.Row columns={2}>
                    ...
                    <Grid.Column mobile={16} tablet={16} computer={16}>
                        ...
                        <Field
                            ...
                            requiredErrorMessage="this is needed"
                            type="checkbox"
                            value={initialValues?.attributeProfile.enabled ? ["enabled"] : []}
                            listen={(values: Map<string, FormValue>) => {
                                setIsAttributeProfileEnabled(values.get("attributeProfile").includes("enabled"));
                            }}
                            children={[
                                {
                                    label: t(
                ...
                <Grid.Row columns={2}>
                    ...
                    <Grid.Column mobile={16} tablet={16} computer={16}>
                        ...
                        <Field
                            ...
                            type="checkbox"
                            value={initialValues?.singleLogoutProfile.enabled ? ["enabled"] : []}
                            listen={(values: Map<string, FormValue>) => {
                                setIsSingleLogoutProfileEnabled(values.get("singleLogoutProfile").includes("enabled"));
                            }}
                            children={[
                                {
                                    label: t(
                    ...
                    <Grid.Column mobile={16} tablet={16} computer={16}>
                        <Field
                            ...
                            validation={(value: string, validation: Validation) => {
                                ...
                                if (
                                    selectedSingleLogoutMethod === LogoutMethods.BACK_CHANNEL &&
                                    commonConfig?.blockLoopBackCalls &&
                ...
                <Grid.Row columns={1}>
                    <Grid.Column mobile={16} tablet={16} computer={16}>
                        ...
                        <Field
                            ...
                            disabled={!isSingleLogoutProfileEnabled}
                            value={
                                initialValues?.singleLogoutProfile.idpInitiatedSingleLogout.enabled ? ["enabled"] : []
                            }
                            listen={(values: Map<string, FormValue>) => {
                ...
                <URLInput
                    ...
                    value={initialValues?.singleLogoutProfile.idpInitiatedSingleLogout.returnToUrls.toString()}
                    placeholder={t(
                        "console:develop.features.applications.forms.inboundSAML.sections" +
                    ...
                    popupHeaderPositive={t("console:develop.features.URLInput.withLabel." + "positive.header")}
                    popupHeaderNegative={t("console:develop.features.URLInput.withLabel." + "negative.header")}
                    popupContentPositive={t("console:develop.features.URLInput.withLabel." + "positive.content", {
                        productName: config.ui.productName
                    })}
                    popupContentNegative={t("console:develop.features.URLInput.withLabel." + "negative.content", {
                        productName: config.ui.productName
                    })}
                    popupDetailedContentPositive={t(
                        "console:develop.features.URLInput." + "withLabel.positive.detailedContent.0"
                ...
                <Grid.Row columns={1}>
                    <Grid.Column mobile={16} tablet={16} computer={16}>
                        <ApplicationCertificateWrapper
                            ...
                            reasonInsideTooltipWhyDeleteIsNotAllowed={t(
                                "console:develop.features.applications.forms." +
