 ...
 *
 */
export const WizardSummary: FunctionComponent<WizardSummaryProps> = (props: WizardSummaryProps): ReactElement => {
    const { summary, triggerSubmit, onSubmit, ["data-testid"]: testId } = props;
        ...
        <Grid className="wizard-summary" data-testid={testId}>
            <Grid.Row>
                <Grid.Column mobile={16} tablet={16} computer={16} textAlign="center">
                    <div className="general-details">
                        <AppAvatar name={summary?.name} image={summary?.imageUrl} size="tiny" />
                        {summary?.name && (
                        ...
                        {summary?.description && <div className="description">{summary.description}</div>}
                    </div>
                </Grid.Column>
            </Grid.Row>
            {summary?.accessUrl && (
            ...
            summary.inboundProtocolConfiguration.oidc.grantTypes.length > 0 ? (
                <Grid.Row className="summary-field" columns={2}>
                    ...
                    <Grid.Column mobile={16} tablet={8} computer={8} textAlign="left">
                        <Label.Group>
                            {summary.inboundProtocolConfiguration.oidc.grantTypes.map(
            ...
            {summary?.inboundProtocolConfiguration?.saml?.manualConfiguration?.assertionConsumerUrls && (
                <Grid.Row className="summary-field" columns={2}>
                    ...
                    <Grid.Column mobile={16} tablet={8} computer={8} textAlign="left">
                        {summary.inboundProtocolConfiguration.saml.manualConfiguration.assertionConsumerUrls.map(
            ...
            {summary?.inboundProtocolConfiguration?.oidc?.callbackURLs && (
                <Grid.Row className="summary-field" columns={2}>
                    ...
                    <Grid.Column mobile={16} tablet={8} computer={8} textAlign="left">
                        ...
                        EncodeDecodeUtils.decodeURLRegex(summary.inboundProtocolConfiguration.oidc.callbackURLs[0]).map(
                            (url: string, index: number) => (
                                <div className="value url" key={index}>
                                    {url}
                                </div>
            ...
            {summary?.inboundProtocolConfiguration?.wsTrust?.audience && (
                <Grid.Row className="summary-field" columns={2}>
                    ...
                    <Grid.Column mobile={16} tablet={8} computer={8} textAlign="left">
                        <div className="value url">{summary?.inboundProtocolConfiguration?.wsTrust?.audience}</div>
                    </Grid.Column>
                </Grid.Row>
            )}
            {summary?.inboundProtocolConfiguration?.wsTrust?.certificateAlias && (
                <Grid.Row className="summary-field" columns={2}>
                    ...
                    <Grid.Column mobile={16} tablet={8} computer={8} textAlign="left">
                        <div className="value">{summary?.inboundProtocolConfiguration?.wsTrust.certificateAlias}</div>
                    </Grid.Column>
                </Grid.Row>
            )}
            ...
            {summary?.inboundProtocolConfiguration?.passiveSts?.replyTo && (
                <Grid.Row className="summary-field" columns={2}>
                    <Grid.Column mobile={16} tablet={8} computer={7} textAlign="right">
                        <div className="label">
                            {t(
                                "console:develop.features.applications.addWizard.steps.summary.sections.audience" +
                                    ".heading"
                            )}
                        </div>
                    </Grid.Column>
                    <Grid.Column mobile={16} tablet={8} computer={8} textAlign="left">
                        <div className="value url">{summary?.inboundProtocolConfiguration?.passiveSts.replyTo}</div>
                    </Grid.Column>
                </Grid.Row>
            )}
        </Grid>
