...
export const SamplesGuideComponent: FunctionComponent<SamplesGuideComponentPropsInterface> = (
    ...
    const { application, markDownSource, sampleType, ["data-testid"]: testId } = props;
    ...
    const downloadConfigFile = (): void => {
        const blob = new Blob([JSON.stringify(authConfig, null, 2)], { type: "application/json" });
    ...
    return (
        <>
                    ...
                    <Grid.Row>
                        <Grid.Column>
                            <Heading as="h5">
                                <strong>
                                    {t(
                                        "console:develop.features.applications.helpPanel.tabs" +
                            ...
                            <Header.Subheader>
                                {t(
                                    "console:develop.features.applications.helpPanel.tabs.samples.content." +
                    ...
                    <Grid.Row>
                        <Grid.Column>
                            ...
                            <Segment secondary padded>
                                <pre>{authConfig ? JSON.stringify(authConfig, null, 2) : null}</pre>
                                <Divider hidden />
            ...
            <Markdown source={markDownSource} data-testid={`${testId}-help-panel-configs-tab-markdown-renderer`} />
        </>
    );
};
