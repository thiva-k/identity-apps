...
export const DesignForm: FunctionComponent<DesignFormPropsInterface> = forwardRef(
    (props: DesignFormPropsInterface, ref: MutableRefObject<FormPropsInterface>): ReactElement => {
        const {
            broadcastValues,
            initialValues,
            isLoading,
        ...
        const [fontConfigurationStrategy, setFontConfigurationStrategy] = useState<FontConfigurationStrategies>(
        ...
        const [fontImportURLFromCDN, setFontImportURLFromCDN] = useState<string>(
            initialValues.theme[theme.activeTheme].typography.font.importURL
        );
        ...
        const { data: customLayoutBlob, isLoading: customLayoutLoading } = useLayout(
        ...
        const FontFamilyDropdown = (): ReactElement => {
            const getFontList = (): DropdownItemProps[] => {
                return BrandingPreferenceMeta.getWebSafeFonts().map((font: string, index: number) => {
                    return {
            ...
            return (
                <Field.Dropdown
                    ...
                    placeholder={t(
                        "extensions:develop.branding.forms.design.theme.font.fields.fontFamilyDropdown.placeholder"
                    )}
                    listen={(value: string) => {
                ...
                if (customLayoutBlob) {
                    ...
                    dispatch(
                        addAlert<AlertInterface>({
                            description: t(
                                "extensions:develop.branding.notifications.fetch.customLayoutNotFound.description",
                                { tenant: tenantDomain }
                            ),
                ...
                <Grid.Row columns={1}>
                    <Grid.Column>
                        <Field.Input
                            ...
                            placeholder={t(
                                "extensions:develop.branding.forms.design.theme.images.logo.fields.url.placeholder"
                            )}
                            hint={
                                <Trans
                                    i18nKey={
                                        "extensions:develop.branding.forms.design.theme.images.logo.fields.url.hint"
                                    }
                                    tOptions={{
                                        productName
                                    }}
                ...
                <Grid.Row columns={1}>
                    <Grid.Column>
                        <Field.Input
                            ...
                            placeholder={t(
                                "extensions:develop.branding.forms.design.theme.images.logo.fields.alt.placeholder"
                            )}
                            hint={t("extensions:develop.branding.forms.design.theme.images.logo.fields.alt.hint", {
                                productName
                            })}
                            required={false}
                ...
                <Grid.Row columns={1}>
                    <Grid.Column>
                        <Field.Input
                            ...
                            placeholder={t(
                                "extensions:develop.branding.forms.design.theme.images.favicon.fields.url.placeholder"
                            )}
                            hint={
                                <Trans
                                    i18nKey={
                            ...
                            readOnly={readOnly}
                            maxLength={
                                BrandingPreferencesConstants.DESIGN_FORM_FIELD_CONSTRAINTS.FAVICON_URL_MAX_LENGTH
                            }
                            minLength={
                                BrandingPreferencesConstants.DESIGN_FORM_FIELD_CONSTRAINTS.FAVICON_URL_MIN_LENGTH
                            }
                            width={16}
                ...
                <Grid.Row columns={1}>
                    <Grid.Column>
                        <Field.Input
                            ...
                            label={t(
                                "extensions:develop.branding.forms.design.theme.images.myAccountLogo.fields.url.label"
                            )}
                            placeholder={t(
                            ...
                            hint={
                                ...
                                >
                                    Use an image that’s atleast <Code>250x50 pixels</Code> for better results. If not
                                    set,
                                    {productName} defaults will be used.
                                </Trans>
                            }
                            ...
                            readOnly={readOnly}
                            maxLength={
                                BrandingPreferencesConstants.DESIGN_FORM_FIELD_CONSTRAINTS.MYACCOUNT_LOGO_URL_MAX_LENGTH
                            }
                            minLength={
                                BrandingPreferencesConstants.DESIGN_FORM_FIELD_CONSTRAINTS.MYACCOUNT_LOGO_URL_MIN_LENGTH
                            }
                            width={16}
                ...
                <Grid.Row columns={1}>
                    <Grid.Column>
                        <Field.Input
                            ...
                            label={t(
                                "extensions:develop.branding.forms.design.theme.images.myAccountLogo.fields.alt.label"
                            )}
                            placeholder={t(
                                "extensions:develop.branding.forms.design.theme" +
                            ...
                            hint={t(
                                "extensions:develop.branding.forms.design.theme" +
                                    ".images.myAccountLogo.fields.alt.hint",
                                { productName }
                            )}
                            required={false}
                ...
                <Grid.Row columns={1}>
                    <Grid.Column>
                        <Field.Input
                            ...
                            label={t(
                                "extensions:develop.branding.forms.design.theme.images.myAccountLogo.fields.title.label"
                            )}
                            placeholder={t(
                                "extensions:develop.branding.forms.design.theme" +
                            ...
                            hint={t(
                                "extensions:develop.branding.forms.design.theme" +
                                    ".images.myAccountLogo.fields.title.hint",
                                { productName }
                            )}
                            required={false}
                ...
                <Grid.Row columns={1}>
                    <Grid.Column>
                        <Field.ColorPicker
                            ...
                            label={t(
                                "extensions:develop.branding.forms.design.theme.colors.fields.secondaryColor.label"
                            )}
                ...
                <Grid.Row columns={1}>
                    <Grid.Column>
                        <Field.ColorPicker
                            ...
                            label={t(
                                "extensions:develop.branding.forms.design.theme.colors.bodyBackground.fields.main.label"
                            )}
                            ...
                            readOnly={readOnly}
                            hint={t(
                                "extensions:develop.branding.forms.design.theme.colors.bodyBackground.fields.main.hint"
                            )}
                            placeholder={t(
                                "extensions:develop.branding.forms.design.theme" +
                ...
                <Grid.Row columns={1}>
                    <Grid.Column>
                        <Field.ColorPicker
                            ...
                            label={t(
                                "extensions:develop.branding.forms.design.theme.colors.outlines.fields.main.label"
                            )}
                            ...
                            readOnly={readOnly}
                            hint={t(
                                "extensions:develop.branding.forms.design.theme" + ".colors.outlines.fields.main.hint"
                            )}
                            placeholder={t(
                                "extensions:develop.branding.forms.design.theme" +
                ...
                <Grid.Row columns={1}>
                    <Grid.Column>
                        <Field.ColorPicker
                            ...
                            label={t(
                                "extensions:develop.branding.forms.design.theme.colors.text.fields.secondary.label"
                            )}
                            ...
                            placeholder={t(
                                "extensions:develop.branding.forms.design.theme.colors.text.fields.secondary.placeholder"
                            )}
                            listen={(value: string) => {
                                setTheme({
                                    ...theme,
                ...
                <Grid.Row columns={1}>
                    <Grid.Column>
                        <Field.ColorPicker
                            ...
                            label={t(
                                "extensions:develop.branding.forms.design.theme.colors.alerts.fields.neutral.label"
                            )}
                            ...
                            placeholder={t(
                                "extensions:develop.branding.forms.design.theme.colors.alerts.fields.neutral.placeholder"
                            )}
                            listen={(value: string) => {
                                setTheme({
                                    ...theme,
                ...
                <Grid.Row columns={1}>
                    <Grid.Column>
                        <Field.ColorPicker
                            ...
                            required={false}
                            readOnly={readOnly}
                            hint={t("extensions:develop.branding.forms.design.theme.colors.alerts.fields.info.hint")}
                            placeholder={t(
                                "extensions:develop.branding.forms.design.theme.colors.alerts.fields.info.placeholder"
                            )}
                            listen={(value: string) => {
                                setTheme({
                                    ...theme,
                ...
                <Grid.Row columns={1}>
                    <Grid.Column>
                        <Field.ColorPicker
                            ...
                            label={t(
                                "extensions:develop.branding.forms.design.theme.colors.alerts.fields.warning.label"
                            )}
                            ...
                            required={false}
                            readOnly={readOnly}
                            hint={t("extensions:develop.branding.forms.design.theme.colors.alerts.fields.warning.hint")}
                            placeholder={t(
                                "extensions:develop.branding.forms.design.theme.colors.alerts.fields.warning.placeholder"
                            )}
                            listen={(value: string) => {
                                setTheme({
                                    ...theme,
                ...
                <Grid.Row columns={1}>
                    <Grid.Column>
                        <Field.ColorPicker
                            ...
                            required={false}
                            readOnly={readOnly}
                            hint={t("extensions:develop.branding.forms.design.theme.colors.alerts.fields.error.hint")}
                            placeholder={t(
                                "extensions:develop.branding.forms.design.theme.colors.alerts.fields.error.placeholder"
                            )}
                            listen={(value: string) => {
                                setTheme({
                                    ...theme,
                ...
                <Grid.Row columns={1}>
                    <Grid.Column>
                        <Field.ColorPicker
                            ...
                            label={t(
                                "extensions:develop.branding.forms.design.theme.loginPage.fields.backgroundColor.label"
                            )}
                            ...
                            readOnly={readOnly}
                            hint={t(
                                "extensions:develop.branding.forms.design.theme.loginPage.fields.backgroundColor.hint"
                            )}
                            placeholder={t(
                                "extensions:develop.branding.forms.design.theme" +
                ...
                <Grid.Row columns={1}>
                    <Grid.Column>
                        <Field.ColorPicker
                            ...
                            placeholder={t(
                                "extensions:develop.branding.forms.design.theme.loginPage.fields.fontColor.placeholder"
                            )}
                            listen={(value: string) =>
                                setTheme({
                                    ...theme,
                ...
                <Grid.Row columns={1}>
                    <Grid.Column>
                        <Field.ColorPicker
                            ...
                            placeholder={t(
                                "extensions:develop.branding.forms.design.theme.footer.fields.borderColor.placeholder"
                            )}
                            listen={(value: string) =>
                                setTheme({
                                    ...theme,
                ...
                <Grid.Row columns={1}>
                    <Grid.Column>
                        <Field.ColorPicker
                            ...
                            placeholder={t(
                                "extensions:develop.branding.forms.design.theme.footer.fields.fontColor.placeholder"
                            )}
                            listen={(value: string) =>
                                setTheme({
                                    ...theme,
                                ...
                                {fontConfigurationStrategy === FontConfigurationStrategies.BROWSER_DEFAULT ? (
                                    ...
                                    <>
                                        <Field.Input
                                            ...
                                            label={t(
                                                "extensions:develop.branding.forms.design.theme.font.fields" +
                                                    ".importURL.label"
                                            )}
                                            placeholder={t(
                                                "extensions:develop.branding.forms.design.theme.font.fields" +
                                            ...
                                            required={false}
                                            value={theme[theme.activeTheme].typography.font.importURL}
                                            readOnly={readOnly}
                                            maxLength={
                                                BrandingPreferencesConstants.DESIGN_FORM_FIELD_CONSTRAINTS
                                                    .FONT_IMPORT_URL_MAX_LENGTH
                                            }
                                            minLength={
                                                BrandingPreferencesConstants.DESIGN_FORM_FIELD_CONSTRAINTS
                                                    .FONT_IMPORT_URL_MIN_LENGTH
                                            }
                ...
                <Grid.Row columns={1}>
                    <Grid.Column>
                        <Field.ColorPicker
                            ...
                            placeholder={t(
                                "extensions:develop.branding.forms.design.theme.headings.fields.fontColor.placeholder"
                            )}
                            listen={(value: string) =>
                                setTheme({
                                    ...theme,
                ...
                <Grid.Row columns={1}>
                    <Grid.Column>
                        <Field.ColorPicker
                            ...
                            readOnly={readOnly}
                            label={t(
                                "extensions:develop.branding.forms.design.theme.buttons.primary.fields.fontColor.label"
                            )}
                            hint={t(
                                "extensions:develop.branding.forms.design.theme.buttons.primary.fields.fontColor.hint"
                            )}
                            placeholder={t(
                                "extensions:develop.branding.forms.design.theme.buttons.primary.fields." +
                ...
                <Grid.Row columns={1}>
                    <Grid.Column>
                        <Field.Input
                            ...
                            label={t(
                                "extensions:develop.branding.forms.design.theme.buttons.primary." +
                ...
                <Grid.Row columns={1}>
                    <Grid.Column>
                        <Field.ColorPicker
                            ...
                            readOnly={readOnly}
                            label={t(
                                "extensions:develop.branding.forms.design.theme.buttons.secondary." +
                ...
                <Grid.Row columns={1}>
                    <Grid.Column>
                        <Field.Input
                            ...
                            placeholder={t(
                                "extensions:develop.branding.forms.design.theme.buttons.secondary.fields" +
                ...
                <Grid.Row columns={1}>
                    <Grid.Column>
                        <Divider horizontal>
                            <Heading as="h6">
                                {t(
                                    "extensions:develop.branding.forms.design.theme.buttons.externalConnections.heading"
                                )}
                            </Heading>
                        </Divider>
                    </Grid.Column>
                ...
                <Grid.Row columns={1}>
                    <Grid.Column>
                        <Field.ColorPicker
                            ...
                            name={`theme.${theme.activeTheme}.buttons.externalConnection.base.background.backgroundColor`}
                            value={
                                initialValues.theme[theme.activeTheme].buttons.externalConnection.base.background
                                    .backgroundColor
                            }
                            ...
                            readOnly={readOnly}
                            label={t(
                                "extensions:develop.branding.forms.design.theme.buttons.externalConnections" +
                ...
                <Grid.Row columns={1}>
                    <Grid.Column>
                        <Field.Input
                            ...
                            value={
                                initialValues.theme[theme.activeTheme].buttons.externalConnection.base.border
                                    .borderRadius
                            }
                            label={t(
                                "extensions:develop.branding.forms.design.theme.buttons.externalConnections" +
                ...
                <Grid.Row columns={1}>
                    <Grid.Column>
                        <Field.ColorPicker
                            ...
                            readOnly={readOnly}
                            label={t(
                                "extensions:develop.branding.forms.design.theme.loginBox.fields.backgroundColor.label"
                            )}
                            hint={t(
                                "extensions:develop.branding.forms.design.theme.loginBox.fields.backgroundColor.hint"
                            )}
                            placeholder={t(
                                "extensions:develop.branding.forms.design.theme.loginBox." +
                                    "fields.backgroundColor.placeholder"
                            )}
                            listen={(value: string) =>
                                setTheme({
                ...
                <Grid.Row columns={1}>
                    <Grid.Column>
                        <Field.ColorPicker
                            ...
                            placeholder={t(
                                "extensions:develop.branding.forms.design.theme.loginBox.fields.fontColor.placeholder"
                            )}
                            listen={(value: string) =>
                                setTheme({
                                    ...theme,
                ...
                <Grid.Row columns={1}>
                    <Grid.Column>
                        <Field.ColorPicker
                            ...
                            readOnly={readOnly}
                            label={t(
                                "extensions:develop.branding.forms.design.theme.loginBox.fields.borderColor.label"
                            )}
                            hint={t("extensions:develop.branding.forms.design.theme.loginBox.fields.borderColor.hint")}
                            placeholder={t(
                                "extensions:develop.branding.forms.design.theme.loginBox.fields.borderColor.placeholder"
                            )}
                            listen={(value: string) =>
                                setTheme({
                                    ...theme,
                ...
                <Grid.Row columns={1}>
                    <Grid.Column>
                        <Field.Input
                            ...
                            label={t(
                                "extensions:develop.branding.forms.design.theme.loginBox.fields.borderWidth.label"
                            )}
                            hint={t("extensions:develop.branding.forms.design.theme.loginBox.fields.borderWidth.hint")}
                            placeholder={t(
                                "extensions:develop.branding.forms.design.theme.loginBox.fields.borderWidth.placeholder"
                            )}
                            required={false}
                            readOnly={readOnly}
                            maxLength={
                                BrandingPreferencesConstants.DESIGN_FORM_FIELD_CONSTRAINTS.BORDER_WIDTH_MAX_LENGTH
                            }
                            minLength={
                                BrandingPreferencesConstants.DESIGN_FORM_FIELD_CONSTRAINTS.BORDER_WIDTH_MIN_LENGTH
                            }
                            width={16}
                ...
                <Grid.Row columns={1}>
                    <Grid.Column>
                        <Field.Input
                            ...
                            label={t(
                                "extensions:develop.branding.forms.design.theme.loginBox.fields.borderRadius.label"
                            )}
                            hint={t("extensions:develop.branding.forms.design.theme.loginBox.fields.borderRadius.hint")}
                            placeholder={t(
                                "extensions:develop.branding.forms.design.theme.loginBox.fields.borderRadius.placeholder"
                            )}
                            required={false}
                            readOnly={readOnly}
                            maxLength={
                ...
                <Grid.Row columns={1}>
                    <Grid.Column>
                        <Field.ColorPicker
                            ...
                            readOnly={readOnly}
                            label={t(
                                "extensions:develop.branding.forms.design.theme.inputs.fields.backgroundColor.label"
                            )}
                            hint={t(
                                "extensions:develop.branding.forms.design.theme.inputs.fields.backgroundColor.hint"
                            )}
                            placeholder={t(
                                "extensions:develop.branding.forms.design.theme.inputs." +
                                    "fields.backgroundColor.placeholder"
                            )}
                            listen={(value: string) =>
                                setTheme({
                ...
                <Grid.Row columns={1}>
                    <Grid.Column>
                        <Field.ColorPicker
                            ...
                            placeholder={t(
                                "extensions:develop.branding.forms.design.theme.inputs.fields.fontColor.placeholder"
                            )}
                            listen={(value: string) =>
                                setTheme({
                                    ...theme,
                ...
                <Grid.Row columns={1}>
                    <Grid.Column>
                        <Field.ColorPicker
                            ...
                            placeholder={t(
                                "extensions:develop.branding.forms.design.theme.inputs.fields.borderColor.placeholder"
                            )}
                ...
                <Grid.Row columns={1}>
                    <Grid.Column>
                        <Field.Input
                            ...
                            placeholder={t(
                                "extensions:develop.branding.forms.design.theme.inputs.fields.borderRadius.placeholder"
                            )}
                            maxLength={
                                BrandingPreferencesConstants.DESIGN_FORM_FIELD_CONSTRAINTS.BORDER_RADIUS_MAX_LENGTH
                            }
                ...
                <Grid.Row columns={1}>
                    <Grid.Column>
                        <Field.ColorPicker
                            ...
                            readOnly={readOnly}
                            label={t(
                                "extensions:develop.branding.forms.design.theme.inputs.labels.fields.fontColor.label"
                            )}
                            hint={t(
                                "extensions:develop.branding.forms.design.theme.inputs.labels.fields.fontColor.hint"
                            )}
                            placeholder={t(
                                "extensions:develop.branding.forms.design.theme.inputs." +
        ...
        return (
            ...
            >
                ...
                <div>
                    {Object.keys(PredefinedLayouts).map((layoutKey: PredefinedLayouts, index: number) => {
                        ...
                        const basename: string = AppConstants.getAppBasename()
                            ...
                            : "";
                        const imageURL: string = `${basename}/libs/themes/${themeName}/assets/images/branding/layouts/${layoutName}.svg`;
                            ...
                            <Field.Radio
                                ...
                                label={t(
                                    "extensions:develop.branding.forms.design." +
                                        `layout.variations.fields.${layoutName}.label`
                                )}
                                required={false}
                                readOnly={readOnly}
                                value={layoutName}
                                ...
                                image={{
                                    altText: t(
                                        "extensions:develop.branding.forms.design." +
                                            `layout.variations.fields.${layoutName}.imgAlt`
                                    ),
                                    imgURL: imageURL
                                }}
                ...
                <div>
                    ...
                    <Text muted compact>
                        ...
                        >
                            Select a color theme for your interfaces. You can further customize these themes using the
                            options given below. By default, the light theme ({productName} theme) is selected.
                        </Trans>
                    </Text>
                </div>
                <div>
                    {Object.keys(BrandingPreferenceMeta.getThemes()).map((_theme: PredefinedThemes, index: number) => {
                        const meta: ThemeSwatchUIConfigsInterface = BrandingPreferenceMeta.getThemeSwatchConfigs(
                            _theme as PredefinedThemes
                        );
                        ...
                        return (
                            <Field.Radio
                                ...
                                label={t(
                                    "extensions:develop.branding.forms.design." +
                                        `theme.variations.fields.${_theme.toLocaleLowerCase()}.label`
                                )}
                                required={false}
                                readOnly={readOnly}
                                value={_theme}
