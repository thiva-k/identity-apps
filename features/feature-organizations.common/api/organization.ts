...
export const shareApplication = (
    ...
    const requestConfig: AxiosRequestConfig = {
        ...
        url: isLegacyAuthzRuntime()
            ? `${
                  store.getState().config.endpoints.organizations
              }/organizations/${currentOrganizationId}/applications/` + `${applicationId}/share`
            : `${store.getState().config.endpoints.applications}/${applicationId}/share`
    };
 ...
 */
export const getSharedOrganizations = (currentOrganizationId: string, applicationId: string): Promise<any> => {
    const requestConfig: AxiosRequestConfig = {
        headers: {
            Accept: "application/json",
            "Access-Control-Allow-Origin": store.getState().config.deployment.clientHost,
 ...
 * @returns
 */
export const unshareApplication = (applicationId: string, currentOrganizationId: string): Promise<any> => {
    const requestConfig: AxiosRequestConfig = {
        headers: {
            Accept: "application/json",
            "Content-Type": "application/json"
