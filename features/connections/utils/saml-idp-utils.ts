 ...
 * @param metadata - authenticator metadata.
 */
 ...
 *
 * @param authenticator - authenticator object with meta and data properties.
 */
...
export const hasLength = (minMax: MinMaxLength) => (value: string): string | undefined => {
