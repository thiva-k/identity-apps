 ...
 */
interface EnterpriseConnectionCreateWizardProps
...
export const EnterpriseConnectionCreateWizard: FC<EnterpriseConnectionCreateWizardProps> = (
    ...
    const { onWizardClose, onIDPCreate, title, subTitle, template, ["data-componentid"]: componentId } = props;
    ...
    useEffect(() => {
        ...
        const templateId: string = selectedProtocol === "saml" ? "enterprise-saml-idp" : "enterprise-oidc-idp";
    ...
    const handleFormSubmit = (values: any) => {
        ...
        if (selectedProtocol === "oidc") {
            ...
            identityProvider.templateId = template.subTemplates.find((template: ConnectionTemplateInterface) => {
    ...
    const resolveHelpPanel = () => {
        ...
        const subTemplate: ConnectionTemplateInterface = cloneDeep(
            template.subTemplates.find(({ id }: { id: string }) => {
                return id === (selectedProtocol === "saml" ? "enterprise-saml-idp" : "enterprise-oidc-idp");
            })
        );
