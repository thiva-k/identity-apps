...
export const IdpCertificatesList: FC<IdpCertificatesListProps> = (
    ...
    const { ["data-componentid"]: testId, currentlyEditingIdP, refreshIdP, isReadOnly, templateType } = props;
    ...
    const handleDeletePEMCertificate = async (certificateIndex: number): Promise<void> => {
        ...
        if (
            ...
            displayingCertificates.length === 1 &&
            !currentlyEditingIdP?.certificate?.jwksUri
        ) {
    ...
    return (
        <Form id={FORM_ID} onSubmit={CertificateManagementConstants.NO_OPERATIONS} uncontrolledForm={true}>
            ...
            <ConfirmationModal
                ...
                assertionHint={t(
                    "console:develop.features.authenticationProvider." + "confirmations.deleteCertificate.assertionHint"
                )}
