    ...
    const createIdpGroup = (): void => {
        ...
        if (groupsList.some((group: ConnectionGroupInterface) => group.name === groupName.trim())) {
            dispatch(
                addAlert({
                    description: t(
                        "extensions:console.identityProviderGroups.createGroupWizard.notifications." +
    ...
    return (
        ...
        >
            <Modal.Header className="wizard-header">
                ...
                <Heading as="h6">{t("extensions:console.identityProviderGroups.createGroupWizard.subHeading")}</Heading>
            </Modal.Header>
                    ...
                    <Grid.Row columns={1} key={1}>
                        <Grid.Column mobile={16} tablet={16} computer={10} key="identityProviderGroupName">
                            <Form.Input
                                ...
                                label={t(
                                    "extensions:console.identityProviderGroups.createGroupWizard." + "groupNameLabel"
                                )}
                                placeholder={t(
                                    "extensions:console.identityProviderGroups.createGroupWizard." +
                            ...
                            />
                            <Hint>
                                {t("extensions:console.identityProviderGroups.createGroupWizard." + "groupNameHint")}
                            </Hint>
                        </Grid.Column>
                    </Grid.Row>
                </Grid>
