...
export class AppConstants {
    ...
    public static getPaths(): Map<string, string> {
        ...
        const paths: Map<string, string> = new Map<string, string>([
            ...
            ["ANALYTICS", `${AppConstants.getAdminViewBasePath()}/analytics/:categoryId/:connectorId`],
            ...
            ["APPLICATION_SIGN_IN_METHOD_EDIT", `${AppConstants.getDeveloperViewBasePath()}/applications/:id:tabName`],
            ...
            ["CLAIM_VERIFICATION_SETTINGS", `${AppConstants.getAdminViewBasePath()}/attribute-verification-settings`],
            ...
            ["ASSIGN_ORGANIZATION_DISCOVERY_DOMAINS", `${AppConstants.getAdminViewBasePath()}/email-domain-assign`],
            ...
            ["EMAIL_TEMPLATE", `${AppConstants.getAdminViewBasePath()}/email-templates/:templateTypeId/:templateId`],
            [
                "EMAIL_TEMPLATE_ADD",
            ...
            ["IDVP_TEMPLATES", `${AppConstants.getDeveloperViewBasePath()}/identity-verification-providers/templates`],
            ...
            ["GOVERNANCE_CONNECTOR_EDIT", `${AppConstants.getAdminViewBasePath()}/connector/:categoryId/:connectorId`],
            [
            ...
            ["SERVER", `${AppConstants.getAdminViewBasePath()}/server`],
            [
                "INTERNAL_NOTIFICATION_SENDING",
                `${AppConstants.getAdminViewBasePath()}/server/internal-notification-sending`
            ],
            ["OUTBOUND_PROVISIONING_SETTINGS", `${AppConstants.getAdminViewBasePath()}/outbound-provisioning-settings`]
        ]);
    ...
    public static filterGoverananceConnectors(
        ...
        GovernanceConnectorUtils.SHOW_GOVERNANCE_CONNECTORS_FOR_SUBORGS.forEach(
            (connector: GovernanceCategoryForOrgsInterface) => {
     ...
     */
    public static readonly ORGANIZATION_ROUTES: string[] = ["organizations", "organization-roles", "organization-edit"];

    /**
     * Route ids that are enabled in only for an organizations (Not allowed in root organization).
     */
    public static readonly ORGANIZATION_ONLY_ROUTES: string[] = ["roles"];
