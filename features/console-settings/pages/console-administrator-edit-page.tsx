...
import { getUserDetails, updateUserInfo } from "@wso2is/feature-users.common/api/users";
import { EditUser } from "@wso2is/feature-users.common/components/edit-user";
import UserManagementProvider from "@wso2is/feature-users.common/providers/user-management-provider";
...
const ConsoleAdministratorsEditPage: FunctionComponent<ConsoleAdministratorsEditPageInterface> = (
    ...
    const handleBackButtonClick = () => {
        history.push(AppConstants.getPaths().get("CONSOLE_SETTINGS") + `#tab=${ConsoleSettingsModes.ADMINISTRATORS}`);
    };
                    ...
                    <EditAvatarModal
                        ...
                        translations={{
                            ...
                            systemGenAvatars: {
                                ...
                                types: {
                                    initials: t(
                                        "console:common.modals.editAvatarModal.content.systemGenAvatars." +
                                            "types.initials"
                                    )
                                }
                            }
