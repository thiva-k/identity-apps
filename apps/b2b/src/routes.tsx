...
import { getSidePanelIcons } from "@wso2is/features/core/configs/ui";
    ...
    const routes: RouteInterface[] = values(
        merge(
            keyBy(
                compact([
                    {
                        component: lazy(() => import("@wso2is/features/extensions/components/getting-started/getting-started")),
                        exact: false,
                        icon: {
                    ...
                    },
                    {
                        children: [
                            {
                                component: lazy(() => import("@wso2is/features/session-management/pages/session-management")),
                                exact: true,
                            ...
                            {
                                component: lazy(() => import("@wso2is/features/saml2-configuration/pages/saml2-configuration")),
                                exact: true,
                            ...
                            {
                                component: lazy(() => import("@wso2is/features/wsfed-configuration/pages/wsfed-configuration")),
                                exact: true,
                            ...
                            {
                                component: lazy(() =>
                                    import("@wso2is/features/server-configurations/" + "pages/connector-edit-page")
                                ),
                                exact: true,
                                icon: {
                            ...
                            },
                            {
                                ...
                                path: AppConstants.getPaths()
                                    ...
                                    .replace(":connectorId", ServerConfigurationsConstants.ADMIN_FORCED_PASSWORD_RESET),
                                protected: true,
                                showOnSidePanel: false
                            },
                            // {
                        ...
                        component: lazy(() =>
                            import("@wso2is/features/server-configurations/pages/connector-listing-page")
                        ),
                        exact: false,
                        icon: {
                    ...
                    },
                    {
                        ...
                        children: [
                            {
                                component: lazy(() =>
                                    import(
                                        "@wso2is/features/identity-verification-providers/pages/" +
                            ...
                            },
                            {
                                component: lazy(() =>
                                    import(
                                        "@wso2is/features/identity-verification-providers/pages/identity-verification-provider-edit"
                                    )
                                ),
                                exact: true,
                                icon: {
                        ...
                        component: lazy(() =>
                            import("@wso2is/features/identity-verification-providers/pages/identity-verification-providers")
                        ),
                        exact: true,
                    ...
                    },
                    {
                        ...
                        children: [
                            {
                                component: lazy(() => import("@wso2is/features/claims/pages/local-claims-edit")),
                                exact: true,
                                icon: {
                                    icon: getSidePanelIcons().childIcon
                                },
                            ...
                            {
                                component: lazy(() => import("@wso2is/features/claims/pages/local-claims")),
                                exact: true,
                                icon: {
                                    icon: getSidePanelIcons().childIcon
                                },
                            ...
                            {
                                component: lazy(() => import("@wso2is/features/claims/pages/external-dialect-edit")),
                                exact: true,
                                icon: {
                                    icon: getSidePanelIcons().childIcon
                                },
                            ...
                            {
                                component: lazy(() => import("@wso2is/features/claims/pages/attribute-mappings")),
                                exact: true,
                                icon: {
                                    icon: getSidePanelIcons().childIcon
                                },
                            ...
                            {
                                component: lazy(() => import("@wso2is/features/claims/pages/attribute-verification-settings")),
                                exact: true,
                                icon: {
                                    icon: getSidePanelIcons().childIcon
                                },
                        ...
                        component: lazy(() => import("@wso2is/features/claims/pages/claim-dialects")),
                        exact: true,
                        icon: {
                    ...
                    },
                    {
                        ...
                        children: [
                            {
                                component: lazy(() => import("@wso2is/features/oidc-scopes/pages/oidc-scopes-edit")),
                                exact: true,
                                icon: {
                                    icon: getSidePanelIcons().childIcon
                                },
                        ...
                        component: lazy(() => import("@wso2is/features/oidc-scopes/pages/oidc-scopes")),
                        exact: true,
                        icon: {
                    ...
                    },
                    {
                        children: [
                            {
                                component: lazy(() =>
                                    import("@wso2is/features/organizations/pages/organization-edit")
                                ),
                                exact: true,
                                icon: {
                    ...
                    },
                    {
                        ...
                        component: lazy(() => {
                            return import("@wso2is/features/organization-discovery/pages/organization-discovery-domains-page");
                        }),
                        exact: true,
                        icon: {
                    ...
                    },
                    {
                        ...
                        component: lazy(() => import("@wso2is/features/branding/pages/branding")),
                        exact: true,
                        icon: {
                            icon: import("@wso2is/features/extensions/assets/images/icons/paint-palette-and-brush-outline.svg")
                        },
                        id: "branding",
                    ...
                    },
                    {
                        category: "extensions:develop.sidePanel.categories.branding",
                        component: lazy(() =>
                            import("@wso2is/features/email-management/" + "pages/email-customization")
                        ),
                        exact: true,
                    ...
                    {
                        category: "extensions:develop.sidePanel.categories.branding",
                        component: lazy(() => import("@wso2is/features/email-providers" + "/pages/email-providers")),
                        exact: true,
                        icon: {
                    ...
                    },
                    {
                        ...
                        component: lazy(() => import("@wso2is/features/sms-providers" + "/pages/sms-providers")),
                        exact: true,
                        icon: {
                    ...
                    },
                    {
                        ...
                        children: [
                            ...
                            {
                                component: lazy(() =>
                                    import("@wso2is/features/validation/pages/validation-config-edit")
                                ),
                                exact: true,
                                icon: {
                                    icon: getSidePanelIcons().organization
                            ...
                            {
                                component: lazy(() =>
                                    import("@wso2is/features/private-key-jwt/pages/private-key-jwt-config-edit")
                                ),
                                exact: true,
                                icon: {
                    ...
                    {
                        category: "extensions:develop.sidePanel.categories.monitor",
                        component: lazy(() => import("@wso2is/features/org-insights/pages/org-insights")),
                        exact: true,
                        featureGateIds: [FeatureGateConstants.SAAS_FEATURES_IDENTIFIER],
                        featureStatus: "BETA",
                    ...
                    },
                    {
                        ...
                        path: AppConstants.getPaths()
                            .get("ANALYTICS")
                            .replace(":categoryId", ServerConfigurationsConstants.OTHER_SETTINGS_CONNECTOR_CATEGORY_ID)
                            .replace(":connectorId", ServerConfigurationsConstants.ANALYTICS_ENGINE_CONNECTOR_ID),
                        protected: true,
                        showOnSidePanel: false
                    },
                    {
                    ...
                    },
                    {
                        ...
                        children: [
                            {
                                component: lazy(() => import("@wso2is/features/server/pages/admin-session-advisory-banner-page")),
                                exact: true,
                                icon: {
                                    icon: getSidePanelIcons().childIcon
                                },
                            ...
                            {
                                component: lazy(() => import("@wso2is/features/server/pages/remote-logging-page")),
                                exact: true,
                                icon: {
                                    icon: getSidePanelIcons().childIcon
                                },
                            ...
                            {
                                component: lazy(() => import("@wso2is/features/server/pages/internal-notification-sending-page")),
                                exact: true,
                                icon: {
                                    icon: getSidePanelIcons().childIcon
                                },
                        ...
                        component: lazy(() => import("@wso2is/features/server/pages/server")),
                        exact: true,
                        icon: {
                    ...
                    },
                    {
                        ...
                        component: lazy(() => import("@wso2is/features/workflow-approvals/pages/approvals")),
                        exact: true,
                        icon: {
                    ...
                    },
                    {
                        ...
                        component: lazy(() => import("@wso2is/features/certificates/pages/certificates-keystore")),
                        icon: {
                    ...
                    },
                    {
                        ...
                        children: [
                            {
                                component: lazy(() => import("@wso2is/features/secrets/pages/secret-edit")),
                                exact: false,
                        ...
                        component: lazy(() => import("@wso2is/features/secrets/pages/secrets")),
                        exact: true,
                    ...
                    },
                    {
                        children: [
                            {
                                component: lazy(() => import("@wso2is/features/console-settings/pages/console-roles-edit-page")),
                                exact: false,
                                icon: { icon: getSidePanelIcons().childIcon },
                                id: "consoleRolesEdit",
                            ...
                            {
                                component: lazy(() => {
                                    return import("@wso2is/features/console-settings/pages/console-administrator-edit-page");
                                }),
                                exact: false,
                                icon: { icon: getSidePanelIcons().childIcon },
                        ...
                        component: lazy(() => import("@wso2is/features/console-settings/pages/console-settings-page")),
                        exact: true,
                        icon: {
                    ...
                    // the following routes are not onboarded to the side panel
                    {
                        ...
                        component: lazy(() =>
                            import("@wso2is/features/remote-repository-configuration/pages/remote-repository-config")
                        ),
                        exact: true,
                        icon: {
                    ...
                    {
                        component: lazy(() => import("@wso2is/features/server-configurations/pages/governance-connectors")),
                        exact: true,
                        icon: null,
                    ...
                    {
                        component: lazy(() => import("@wso2is/features/server-configurations/pages/multi-attribute-login-edit")),
                        exact: true,
                        icon: null,
                        id: "multiAttributeLogin",
                        name:
                            "console:manage.features.governanceConnectors.connectorCategories.accountManagement." +
    ...
    if (useExtendedRoutes) {
        routes.push(
            ...
            // },
            {
                ...
                children: [
                    {
                        component: lazy(() => import("@wso2is/features/application-roles/pages/application-role-edit")),
                        exact: true,
                        icon: {
                            icon: getSidePanelIcons().childIcon
                        },
                ...
                component: lazy(() => import("@wso2is/features/application-roles/pages/application-roles")),
                exact: true,
                featureStatus: "NEW",
            ...
            // },
            {
                ...
                component: lazy(() => import("@wso2is/features/parent-roles/parent-roles")),
                exact: true,
                featureStatus: "NEW",
                featureStatusLabel: "common:new",
                icon: {
        ...
        routes.push(
            {
                ...
                children: [
                    {
                        component: lazy(() => import("@wso2is/features/api-resources/pages/api-resource-edit")),
                        exact: true,
                        id: "apiResources-edit",
                        name: "extensions:develop.sidePanel.apiResources",
                    ...
                    {
                        component: lazy(() => import("@wso2is/features/api-resources/pages/api-resources-internal-list")),
                        exact: true,
                ...
                component: lazy(() => import("@wso2is/features/api-resources/pages/api-resources")),
                exact: true,
                icon: {
                    icon: import("@wso2is/features/extensions/assets/images/icons/api-resources-icon.svg")
                },
                id: "apiResources",
                name: "extensions:develop.sidePanel.apiResources",
                order: 2,
            ...
            {
                category: "extensions:manage.sidePanel.categories.userManagement",
                component: lazy(() => import("@wso2is/features/provisioning/pages/outbound-provisioning-settings")),
                exact: true,
                icon: {
                    icon: getSidePanelIcons().childIcon
                },
        ...
        if (legacyMode?.rolesV1) {
            ...
            routes.push({
                ...
                children: [
                    {
                        component: lazy(() => import("@wso2is/features/roles-v1/pages/role-edit")),
                        exact: true,
                        icon: {
                            icon: getSidePanelIcons().childIcon
                        },
                ...
                component: lazy(() => import("@wso2is/features/roles-v1/pages/role")),
                exact: true,
                icon: {
                    icon: getSidePanelIcons().applicationRoles
                },
            ...
            routes.push({
                ...
                children: [
                    {
                        component: lazy(() => import("@wso2is/features/roles/pages/role-edit")),
                        exact: true,
                        icon: {
                            icon: getSidePanelIcons().childIcon
                        },
                    ...
                    {
                        component: lazy(() => import("@wso2is/features/roles/pages/create-role-wizard")),
                        exact: true,
                        icon: {
                            icon: getSidePanelIcons().childIcon
                        },
                ...
                component: lazy(() => import("@wso2is/features/roles/pages/role")),
                exact: true,
                icon: {
                    icon: getSidePanelIcons().applicationRoles
                },
...
export const getDefaultLayoutRoutes = (): RouteInterface[] => {
    ...
    routes.push({
        component: lazy(() => import("@wso2is/features/core/pages/privacy")),
        icon: null,
        id: "privacy",
...
export const getErrorLayoutRoutes = (): RouteInterface[] => {
    return [
        {
            component: lazy(() => import("@wso2is/features/core/pages/errors/unauthorized")),
            exact: true,
            icon: null,
            id: "unauthorized",
            name: "Unauthorized",
        ...
        {
            component: lazy(() => import("@wso2is/features/core/pages/errors/404")),
            exact: true,
            icon: null,
            id: "pageNotFound",
            name: "404",
        ...
        {
            component: lazy(() => import("@wso2is/features/core/pages/errors/storage-disabled")),
            exact: true,
            icon: null,
...
export const getAuthLayoutRoutes = (): RouteInterface[] => {
    const routes: RouteInterface[] = [
        {
            component: lazy(() => import("@wso2is/features/extensions/components/tenants/pages/create-tenant")),
            exact: true,
            icon: null,
            id: "createTenant",
            name: "createTenant",
        ...
        {
            component: lazy(() => import("@wso2is/features/authentication/pages/sign-out")),
            icon: null,
            id: "authLayoutLogout",
            name: "Logout",
