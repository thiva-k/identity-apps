...
import { commonConfig } from "@wso2is/features/extensions/configs/common";
import useAuthorization from "@wso2is/features/authorization/hooks/use-authorization";
import { useGetCurrentOrganizationType } from "@wso2is/features/organizations/hooks/use-get-organization-type";
import { getAppViewRoutes } from "./routes";
import { AppConstants } from "@wso2is/features/core/constants/app-constants";
import { history } from "@wso2is/features/core/helpers/history";
import { FeatureConfigInterface } from "@wso2is/features/core/models/config";
import { AppState, setDeveloperVisibility, setFilteredDevelopRoutes, setSanitizedDevelopRoutes } from "@wso2is/features/core/store";
import { AppUtils } from "@wso2is/features/core/utils/app-utils";
