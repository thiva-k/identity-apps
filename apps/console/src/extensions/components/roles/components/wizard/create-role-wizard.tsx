...
export const CreateRoleWizard: FunctionComponent<CreateRoleProps> = (props: CreateRoleProps): ReactElement => {
    ...
    useEffect(() => {
        setWizardSteps(filterSteps([WizardStepsFormTypes.BASIC_DETAILS, WizardStepsFormTypes.USER_LIST]));
    }, []);
    ...
    return (
        ...
        >
            <Modal.Header className="wizard-header">
                ...
                <Heading as="h6">Assign permissions to a new role and add collaborator users to the role.</Heading>
            </Modal.Header>
            {showStepper && (
