...
import { AppConstants, SharedUserStoreUtils } from "../../../../../features/core";
...
export const BasicRoleDetails: FunctionComponent<BasicRoleProps> = (props: BasicRoleProps): ReactElement => {
    ...
    const { roleObject, onRoleUpdate, isGroup, isReadOnly, ["data-testid"]: testId } = props;
                    ...
                    <Grid className="form-container with-max-width">
                        <Grid.Row columns={1}>
                            <Grid.Column mobile={16} tablet={16} computer={16}>
                                ...
                                <Hint>
                                    A name for the role. Can contain between 3 to 30 alphanumeric characters, dashes (
