...
import { AppConstants, AppState, UIConstants, getEmptyPlaceholderIllustrations } from "../../core";
        ...
        return [
            {
                ...
                render: (role: RolesInterface): ReactNode => (
                    <Header image as="h6" className="header-with-icon" data-testid={`${testId}-item-heading`}>
                        ...
                        />
                        <Header.Content>{generateHeaderContent(role?.displayName)}</Header.Content>
                    </Header>
                ),
