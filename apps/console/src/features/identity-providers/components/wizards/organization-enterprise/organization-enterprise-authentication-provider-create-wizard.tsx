...
import { OrganizationEnterpriseAuthenticationProviderCreateWizardContent } from "./organization-enterprise-authentication-provider-create-wizard-content";
import { identityProviderConfig } from "../../../../../extensions/configs";
import { EventPublisher, ModalWithSidePanel, TierLimitReachErrorModal } from "../../../../core";
 ...
 */
interface OrganizationEnterpriseAuthenticationProviderCreateWizardPropsInterface
            ...
            <ModalWithSidePanel.SidePanel>
                <ModalWithSidePanel.Header className="wizard-header help-panel-header muted">
                    <div className="help-panel-header-text">
                        {t("idp:develop.features.authenticationProvider.templates" + ".facebook.wizardHelp.heading")}
                    </div>
