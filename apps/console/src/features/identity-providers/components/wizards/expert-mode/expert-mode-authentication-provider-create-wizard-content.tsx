 ...
 */
export const ExpertModeAuthenticationProviderCreateWizardContent: FunctionComponent<ExpertModeAuthenticationProviderCreateWizardContentPropsInterface> = (
    ...
    return (
        <Wizard
            ...
            onSubmit={(values: ExpertModeAuthenticationProviderCreateWizardFormValuesInterface) => onSubmit(values)}
        ...
        >
            <WizardPage validate={validateForm}>
                ...
                <Field.Textarea
                    ...
                    name="description"
                    label={t("idp:develop.features.authenticationProvider.forms." + "generalDetails.description.label")}
                    placeholder={t(
                        "idp:develop.features.authenticationProvider.forms." + "generalDetails.description.placeholder"
                    )}
                    required={false}
                    maxLength={
                        IdentityProviderManagementConstants.AUTHENTICATOR_SETTINGS_FORM_FIELD_CONSTRAINTS
