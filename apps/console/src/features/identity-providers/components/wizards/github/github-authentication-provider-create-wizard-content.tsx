 ...
 */
export const GitHubAuthenticationProviderCreateWizardContent: FunctionComponent<GitHubAuthenticationProviderCreateWizardContentPropsInterface> = (
     ...
     */
    const validateForm = (
        values: GitHubAuthenticationProviderCreateWizardFormValuesInterface
    ): GithubAuthenticationProviderCreateWizardFormErrorValidationsInterface => {
    ...
    return isIdPListRequestLoading !== undefined && isIdPListRequestLoading === false ? (
        <Wizard
            ...
            onSubmit={(values: GitHubAuthenticationProviderCreateWizardFormValuesInterface) => onSubmit(values)}
