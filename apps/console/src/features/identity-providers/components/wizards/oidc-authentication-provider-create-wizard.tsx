...
import { AppState, EventPublisher, ModalWithSidePanel, store } from "../../../../features/core";
            ...
            <ModalWithSidePanel.MainPanel>
                ...
                >
                    <div className="display-flex">
                        ...
                        >
                            <span data-testid={`${testId}-title`}>{title && title}</span>
                            {subTitle && (
                                <Header.Subheader data-testid={`${testId}-sub-title`}>{subTitle}</Header.Subheader>
                            )}
                        </Header>
                    </div>
                </ModalWithSidePanel.Header>
