...
import { getFederatedAuthenticatorMetadata, updateFederatedAuthenticator } from "../../api";
...
export const AuthenticatorCreateWizard: FunctionComponent<AddAuthenticatorWizardPropsInterface> = (
    ...
    const [selectedAuthenticatorMetadata, setSelectedAuthenticatorMetadata] = useState<
        FederatedAuthenticatorMetaInterface
    >(undefined);
    ...
    const handleWizardFormFinish = (identityProvider: IdentityProviderInterface): void => {
        const authenticator: FederatedAuthenticatorListItemInterface = identityProvider?.federatedAuthenticators?.authenticators.find(
            ...
            case WizardSteps.TEMPLATE_SELECTION: {
                return (
                    <AuthenticatorTemplateSelection
                        ...
                        onSubmit={(values: any): void => handleWizardFormSubmit(values, false)}
                    ...
                    <>
                        {selectedAuthenticatorMetadata && isEmpty(selectedAuthenticatorMetadata?.properties) && (
                            <EmptyPlaceholder
                                ...
                                imageSize="tiny"
                                title={t(
                                    "idp:develop.features.authenticationProvider.wizards.addAuthenticator." +
                        ...
                        <AuthenticatorSettings
                            ...
                            onSubmit={(values: IdentityProviderInterface): void => handleWizardFormSubmit(values, true)}
    ...
    useEffect(() => {
        if (selectedTemplateId) {
            const selectedTemplate: IdentityProviderTemplateInterface = availableTemplates.find(
    ...
    return (
        ...
        >
            ...
            <Modal.Content className="steps-container" data-testid={`${testId}-modal-content-1`}>
                <Steps.Group
                    header={t("idp:develop.features.authenticationProvider." + "wizards.addAuthenticator.header")}
