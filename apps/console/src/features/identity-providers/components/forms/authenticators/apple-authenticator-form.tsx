...
export const AppleAuthenticatorForm: FunctionComponent<AppleAuthenticatorFormPropsInterface> = (
    ...
    const getUpdatedConfigurations = (
        values: AppleAuthenticatorFormInitialValuesInterface
    ): CommonAuthenticatorFormInitialValuesInterface => {
        ...
        for (const [key, value] of Object.entries(values)) {
            if (key !== undefined) {
                ...
                if (
                    !regenerateSecret &&
                    IdentityProviderManagementConstants.APPLE_AUTHENTICATOR_SECRET_REGENERATIVE_FIELDS.indexOf(key) !==
                        -1 &&
                    originalValues[key] &&
    ...
    return (
        ...
        >
            <Field.Input
                ...
                name="ClientId"
                label={t(
                    "idp:develop.features.authenticationProvider.forms.authenticatorSettings" + ".apple.clientId.label"
                )}
                placeholder={t(
                ...
                hint={t(
                    "idp:develop.features.authenticationProvider.forms.authenticatorSettings" + ".apple.clientId.hint"
                )}
            ...
            <Field.Input
                ...
                name="TeamId"
                label={t(
                    "idp:develop.features.authenticationProvider.forms.authenticatorSettings" + ".apple.teamId.label"
                )}
                placeholder={t(
                    "idp:develop.features.authenticationProvider.forms.authenticatorSettings" +
                ...
                hint={t(
                    "idp:develop.features.authenticationProvider.forms.authenticatorSettings" + ".apple.teamId.hint"
                )}
                required={formFields?.TeamId?.meta?.isMandatory}
                readOnly={
                    readOnly ||
                    (mode === AuthenticatorSettingsFormModes.CREATE ? false : formFields?.TeamId?.meta?.readOnly)
                }
            ...
            <Field.Input
                ...
                name="KeyId"
                label={t(
                    "idp:develop.features.authenticationProvider.forms.authenticatorSettings" + ".apple.keyId.label"
                )}
                placeholder={t(
                    "idp:develop.features.authenticationProvider.forms.authenticatorSettings" +
                ...
                hint={t(
                    "idp:develop.features.authenticationProvider.forms.authenticatorSettings" + ".apple.keyId.hint"
                )}
                required={formFields?.KeyId?.meta?.isMandatory}
                readOnly={
                    readOnly ||
                    (mode === AuthenticatorSettingsFormModes.CREATE ? false : formFields?.KeyId?.meta?.readOnly)
                }
            ...
            <Field.Input
                ...
                hint={t(
                    "idp:develop.features.authenticationProvider.forms.authenticatorSettings" + ".apple.privateKey.hint"
                )}
                required={formFields?.PrivateKey?.meta?.isMandatory}
                readOnly={
                    readOnly ||
                    (mode === AuthenticatorSettingsFormModes.CREATE ? false : formFields?.PrivateKey?.meta?.readOnly)
                }
                ...
                formFields.Scopes.value.split(",").length > 0 && (
                    ...
                    >
                        <div className="authenticator-dynamic-properties">
                            {formFields.Scopes.value.split(",").map((scope: string, index: number) => {
                        ...
                        <Hint compact>
                            ...
                            >
                                The type of access provided for the connected apps to access data from Apple. Click{" "}
                                <a
                                    href={
