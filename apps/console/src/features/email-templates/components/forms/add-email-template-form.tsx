...
export const AddEmailTemplateForm: FunctionComponent<AddEmailTemplateFormPropsInterface> = (
    ...
    const { mode, templateId, templateTypeId, ["data-testid"]: testId } = props;
            ...
            <Grid>
                        ...
                        <Grid.Column mobile={12} tablet={12} computer={4}>
                            <Form.Field>
                                <Field
                                    type="dropdown"
                                    placeholder={t(
                                        "console:manage.features.emailLocale.forms.addLocale.fields.locale" +
                                            ".placeholder"
                                    )}
                                    label={t("console:manage.features.emailLocale.forms.addLocale.fields.locale.label")}
                                    name="locale"
                ...
                <Grid.Row columns={1}>
                    <Grid.Column mobile={12} tablet={12} computer={4}>
                        <Field
                            name="emailSubject"
                            label={t("console:manage.features.emailLocale.forms.addLocale.fields.subject.label")}
                            required={true}
                            requiredErrorMessage={t(
                                "console:manage.features.emailLocale." +
                                    "forms.addLocale.fields.subject.validations.empty"
                            )}
                            placeholder={t(
                                "console:manage.features.emailLocale.forms.addLocale.fields.subject.placeholder"
                            )}
                            type="text"
                            value={subject}
                        ...
                        <Form.Field>
                            ...
                            {isSubmitting && bodyError && (
                                <Message
                                    ...
                                    type="error"
                                    content={t(
                                        "console:manage.features.emailLocale.forms.addLocale.fields." +
                ...
                <Grid.Row columns={1}>
                    <Grid.Column mobile={12} tablet={12} computer={12}>
                        <Form.Field>
                            <label>
                                {t(
                                    "console:manage.features.emailLocale.forms.addLocale.fields.signatureEditor" +
                                        ".label"
                                )}
                            </label>
                            <EmailTemplateEditor
