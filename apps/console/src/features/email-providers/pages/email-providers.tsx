...
const EmailProvidersPage: FunctionComponent<EmailProvidersPageInterface> = (
    ...
    const [emailProviderConfig, setEmailProviderConfig] = useState<EmailProviderConfigFormValuesInterface>(undefined);
    ...
    useEffect(() => {
        ...
        if (
            ...
            const displayNameProperty: EmailProviderConfigPropertiesInterface = originalEmailProviderConfig[0].properties.find(
                (property: EmailProviderConfigPropertiesInterface) =>
                    property.key === EmailProviderConstants.SIGNATURE_KEY
            );

            const replyToProperty: EmailProviderConfigPropertiesInterface = originalEmailProviderConfig[0].properties.find(
                (property: EmailProviderConfigPropertiesInterface) =>
    ...
    const handleRetrieveError = (): void => {
        dispatch(
            addAlert({
                description: t(
                    "extensions:develop.emailProviders." + "notifications.getConfiguration.error.description"
                ),
                level: AlertLevels.ERROR,
                message: t("extensions:develop.emailProviders." + "notifications.getConfiguration.error.message")
            })
        );
    };
    ...
    const handleUpdateSuccess = () => {
        dispatch(
            addAlert({
                description: t(
                    "extensions:develop.emailProviders." + "notifications.updateConfiguration.success.description"
                ),
                level: AlertLevels.SUCCESS,
                message: t("extensions:develop.emailProviders." + "notifications.updateConfiguration.success.message")
            })
        );
    };
    ...
    const handleUpdateError = () => {
        dispatch(
            addAlert({
                description: t(
                    "extensions:develop.emailProviders." + "notifications.updateConfiguration.error.description"
                ),
                level: AlertLevels.ERROR,
                message: t("extensions:develop.emailProviders." + "notifications.updateConfiguration.error.message")
            })
        );
    };
    ...
    const handleDeleteSuccess = () => {
        dispatch(
            addAlert({
                description: t(
                    "extensions:develop.emailProviders." + "notifications.deleteConfiguration.success.description"
                ),
                level: AlertLevels.SUCCESS,
                message: t("extensions:develop.emailProviders." + "notifications.deleteConfiguration.success.message")
            })
        );
    };
    ...
    const handleDeleteError = () => {
        dispatch(
            addAlert({
                description: t(
                    "extensions:develop.emailProviders." + "notifications.deleteConfiguration.error.description"
                ),
                level: AlertLevels.ERROR,
                message: t("extensions:develop.emailProviders." + "notifications.deleteConfiguration.error.message")
            })
        );
    };
    ...
    const validateForm = (
        ...
        if (!values?.fromAddress) {
            error.fromAddress = t("extensions:develop.emailProviders.form.validations.required");
        }

        if (!values?.smtpPort) {
            error.smtpPort = t("extensions:develop.emailProviders.form.validations.required");
        }

        if (!values?.smtpServerHost) {
            error.smtpServerHost = t("extensions:develop.emailProviders.form.validations.required");
        }

        if (!values?.replyToAddress) {
            error.replyToAddress = t("extensions:develop.emailProviders.form.validations.required");
        }
        ...
        if (!values?.displayName) {
            error.displayName = t("extensions:develop.emailProviders.form.validations.required");
        }

        if (
            values?.smtpPort &&
            (!FormValidation.isInteger(values.smtpPort as number) || (values.smtpPort as number) < 0)
        ) {
            error.smtpPort = t("extensions:develop.emailProviders.form.validations.portInvalid");
        }

        if (values?.fromAddress && !EmailProviderConstants?.EMAIL_REGEX?.test(values.fromAddress)) {
            error.fromAddress = t("extensions:develop.emailProviders.form.validations.emailInvalid");
        }

        if (values?.replyToAddress && !EmailProviderConstants?.EMAIL_REGEX?.test(values.replyToAddress)) {
            error.replyToAddress = t("extensions:develop.emailProviders.form.validations.emailInvalid");
        }
        ...
        return (
            <div>
                <div style={{ whiteSpace: "pre-line" }}>
                    ...
                    <DocumentationLink link={getLink("develop.emailProviders.learnMore")}>
        ...
        <PageLayout
            ...
            action={
                ...
                hasRequiredScopes(
                    ...
                    <SecondaryButton onClick={goToEmailTemplates} data-componentId="email-templates-configure-button">
                        ...
                        <Grid.Column width={16}>
                                                ...
                                                <Grid.Row columns={2} key={1}>
                                                        ...
                                                        <Field.Input
                                                            ...
                                                            hint={
                                                                ...
                                                                >
                                                                    ...
                                                                    <Code>smtp</Code>, followed by the domain name of
                                                    ...
                                                    <Grid.Column key="smtpPort">
                                                        <Field.Input
                                                            ...
                                                            readOnly={isReadOnly}
                                                            maxLength={
                                                                EmailProviderConstants.EMAIL_PROVIDER_SERVER_PORT_MAX_LENGTH
                                                            }
                                                            minLength={
                                                                EmailProviderConstants.EMAIL_PROVIDER_CONFIG_FIELD_MIN_LENGTH
                                                            }
                                                ...
                                                <Grid.Row columns={2} key={2}>
                                                    ...
                                                    <Grid.Column key="replyToAddress">
                                                        <Field.Input
                                                            ...
                                                            width={16}
                                                            data-componentid={`${componentId}-smtp-reply-to-address`}
                                                            autoComplete="new-password"
                                                        />
                                                    </Grid.Column>
                                                </Grid.Row>
                            ...
                            {!isReadOnly && !isEmailProviderConfigFetchRequestLoading && (
                                <>
                                    ...
                                    <DangerZoneGroup
                                        sectionHeader={t(
                                            "extensions:develop.emailProviders.dangerZoneGroup" + ".header"
                                        )}
                                    >
                                        <DangerZone
                                            data-componentid={`${componentId}-revert-email-provider-config`}
                                            actionTitle={t(
                                                "extensions:develop.emailProviders.dangerZoneGroup" +
                                    ...
                                    <ConfirmationModal
                                        ...
                                        assertionHint={t(
                                            "extensions:develop.emailProviders.confirmationModal" + ".assertionHint"
                                        )}
