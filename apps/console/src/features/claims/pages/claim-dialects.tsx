...
import { AppConstants, AppState, FeatureConfigInterface, getSidePanelIcons, getTechnologyLogos } from "../../core";
                    ...
                    {hasRequiredScopes(
                        ...
                        (isLoading ? (
                            ...
                            <>
                                <Header as="h4">
                                    {t(
                                        "console:manage.features.claims.dialects." + "sections.manageAttributes.heading"
                                    )}
                                </Header>
                                <Divider hidden />
                                <EmphasizedSegment
                                            ...
                                            <Grid>
                                                <Grid.Row columns={2}>
                                                    ...
                                                    <Grid.Column
                                                        ...
                                                        textAlign="right"
                                                        data-testid={
                                                            `${testId}-local-dialect-` + "attributes-edit-icon"
                                                        }
                                                    >
                                                        <Popup
                                                            content={
                                ...
                                {!isSAASDeployment &&
                                    ...
                                    hasRequiredScopes(
                                        ...
                                        <EmphasizedSegment
                                            onClick={() => {
                                                history.push(
                                                    AppConstants.getPaths().get("CLAIM_VERIFICATION_SETTINGS")
                                                );
                                            }}
                                            className="clickable"
                                                    ...
                                                    <Grid>
                                                        <Grid.Row columns={2}>
                                                            <Grid.Column width={12}>
                                                                ...
                                                                <List.Description
                                                                    data-testid={
                                                                        `${testId}-attribute-verification` + "-settings"
                                                                    }
                                                                >
                                                                    {t(
                                                                        "console:manage.features." +
                                                            ...
                                                            >
                                                                <Popup
                                                                    content={
                                                                        hasRequiredScopes(
                                                                            featureConfig?.attributeDialects,
                                                                            featureConfig?.attributeDialects?.scopes
                                                                                ?.create,
                                                                            allowedScopes
                                                                        )
                                                                            ? t("common:configure")
                    ...
                    {attributeConfig.showCustomAttributeMapping &&
                        (isLoading
                            ...
                            : otherAttributeMappings?.length > 0 &&
                              otherAttributeMappings.map((customAttributeMapping: ClaimDialect) => (
                                  <EmphasizedSegment
                                      ...
                                      onClick={() => {
                                          history.push(
                                              AppConstants.getPaths()
                                                  ...
                                                  .replace(":customAttributeMappingID", customAttributeMapping.id)
                                          );
                                      }}
                                      className="clickable"
                                              ...
                                              <Grid>
                                                  <Grid.Row columns={2}>
                                                      <Grid.Column width={12}>
                                                          ...
                                                          <List.Header>{customAttributeMapping.dialectURI}</List.Header>
                                                          <List.Description data-testid={`${testId}-local-dialect`}>
                                                              {t(
                                                                  "console:manage.features.claims." +
                                                                      "attributeMappings." +
