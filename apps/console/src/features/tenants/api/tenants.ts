...
export const addNewTenant = (tenantName: string): Promise<AxiosResponse> => {
    const requestConfig: AxiosRequestConfig = {
        ...
        url: store.getState().config.endpoints.tenantManagementApi + getDomainQueryParam()
    };
...
export const makeTenantDefault = (tenantName: string): Promise<AxiosResponse> => {
    const requestConfig: AxiosRequestConfig = {
        ...
        url: store.getState().config.endpoints.tenantManagementApi + "/default/" + tenantName + getDomainQueryParam()
    };
...
export const checkDuplicateTenants = (tenantName: string): Promise<AxiosResponse> => {
    const requestConfig: AxiosRequestConfig = {
        ...
        url: store.getState().config.endpoints.tenantManagementApi + "/" + tenantName + getDomainQueryParam()
    };
