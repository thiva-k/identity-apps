...
import { AppConstants, getSecretManagementIllustrations } from "../../core";
...
const SecretEdit: FC<SecretEditProps> = (props: SecretEditProps): ReactElement => {
    ...
    return resourceNotFound ? (
        <EmptySecretListPlaceholder onAddNewSecret={null} resourceNotFound />
    ) : (
        <PageLayout
            isLoading={loading}
            title={secretName}
        ...
        >
            {loading && !resourceNotFound ? (
                ...
                <EditSecret data-componentid={testId} editingSecret={editingSecret} />
            )}
        </PageLayout>
    );
};
