...
} from "@wso2is/features/core/models";
 ...
 */
export const ConnectionPage: FunctionComponent<Record<string, never>> = (): ReactElement => {
                                ...
                                >
                                    <>
                                        ...
                                        <Switch>
                                            ...
                                            {connectionRoutes.map((route: RouteInterface, index: number) => {
